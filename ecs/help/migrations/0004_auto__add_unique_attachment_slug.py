...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Attachment', fields ['slug']
        db.create_unique('help_attachment', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Attachment', fields ['slug']
        db.delete_unique('help_attachment', ['slug'])
