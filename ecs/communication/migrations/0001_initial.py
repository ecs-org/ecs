...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Thread'
        db.create_table('communication_thread', (
            ...
            ('last_message', self.gf('django.db.models.fields.related.OneToOneField')(related_name='head', unique=True, null=True, to=orm['communication.Message'])),
            ('closed_by_sender', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('closed_by_receiver', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('communication', ['Thread'])

        # Adding model 'Message'
        db.create_table('communication_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['communication.Thread'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outgoing_messages', to=orm['auth.User'])),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incoming_messages', to=orm['auth.User'])),
            ('reply_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='replies', null=True, to=orm['communication.Message'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ...
            ('rawmsg', self.gf('django.db.models.fields.TextField')(null=True)),
            ('rawmsg_msgid', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, db_index=True)),
            ('rawmsg_digest_hex', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, db_index=True)),
            ('origin', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('smtp_delivery_state', self.gf('django.db.models.fields.CharField')(default='new', max_length=7, db_index=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='22d6b872b8d044e09b847456e5a99c0b', max_length=32, db_index=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('communication_thread')
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3c09aa1f45974789919a6a4fd988fb76'", 'max_length': '32', 'db_index': 'True'})
        },
