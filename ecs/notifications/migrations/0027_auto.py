...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_notification_documents', (
        ...
        db.create_unique('notifications_notification_documents', ['notification_id', 'document_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field documents on 'Notification'
        db.delete_table('notifications_notification_documents')
