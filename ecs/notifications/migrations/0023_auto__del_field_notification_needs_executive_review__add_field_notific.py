...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notification.needs_executive_review'
        db.delete_column('notifications_notification', 'needs_executive_review')

        # Adding field 'Notification.review_lane'
        db.add_column('notifications_notification', 'review_lane', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Notification.needs_executive_review'
        db.add_column('notifications_notification', 'needs_executive_review', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Notification.review_lane'
        db.delete_column('notifications_notification', 'review_lane')
    ...
    models = {
        ...
        'core.submission': {
            ...
            'is_expedited': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_finished': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_mpg': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_retrospective': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_thesis': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
