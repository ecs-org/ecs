...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompletionReportNotification.notification_ptr'
        db.alter_column('notifications_completionreportnotification', 'notification_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['notifications.Notification'], unique=True, primary_key=True))

        # Changing field 'Notification.timestamp'
        db.alter_column('notifications_notification', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'CompletionReportNotification.notification_ptr'
        db.alter_column('notifications_completionreportnotification', 'notification_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['notifications.Notification'], unique=True))

        # Changing field 'Notification.timestamp'
        db.alter_column('notifications_notification', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'81ebaa9a90e646ed95c829961c9305ec'", 'unique': 'True', 'max_length': '36'}),
        ...
        'notifications.amendmentnotification': {
            'Meta': {'object_name': 'AmendmentNotification', '_ormbases': ['notifications.Notification']},
            'new_submission_form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'new_for_notification'", 'to': "orm['core.SubmissionForm']"}),
            ...
            'old_submission_form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_for_notification'", 'to': "orm['core.SubmissionForm']"})
        },
        'notifications.completionreportnotification': {
            'Meta': {'object_name': 'CompletionReportNotification'},
            'SAE_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'SUSAR_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'study_started': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'notifications.notification': {
            'Meta': {'object_name': 'Notification'},
            'comments': ('django.db.models.fields.TextField', [], {}),
            'date_of_receipt': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'notifications'", 'symmetrical': 'False', 'to': "orm['documents.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pdf_document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_notification'", 'unique': 'True', 'null': 'True', 'to': "orm['documents.Document']"}),
            'review_lane': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'db_index': 'True'}),
        ...
        'notifications.notificationanswer': {
            ...
            'notification': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'answer'", 'unique': 'True', 'to': "orm['notifications.Notification']"}),
            'pdf_document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_notification_answer'", 'unique': 'True', 'null': 'True', 'to': "orm['documents.Document']"}),
        ...
        'notifications.notificationtype': {
            ...
            'default_response': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'finishes_study': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'form': ('django.db.models.fields.CharField', [], {'default': "'ecs.notifications.forms.NotificationForm'", 'max_length': '80'}),
            'grants_vote_extension': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'includes_diff': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_rejectable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
        ...
        'notifications.safetynotification': {
            'Meta': {'object_name': 'SafetyNotification', '_ormbases': ['notifications.Notification']},
            'is_acknowledged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'notification_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['notifications.Notification']", 'unique': 'True', 'primary_key': 'True'}),
            'reviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'safety_type': ('django.db.models.fields.CharField', [], {'max_length': '6', 'db_index': 'True'})
        },
        'votes.vote': {
