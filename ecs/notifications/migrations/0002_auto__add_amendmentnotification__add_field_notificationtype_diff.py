...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AmendmentNotification'
        db.create_table('notifications_amendmentnotification', (
            ...
            ('old_submission_form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_for_notification', to=orm['core.SubmissionForm'])),
            ('new_submission_form', self.gf('django.db.models.fields.related.ForeignKey')(related_name='new_for_notification', to=orm['core.SubmissionForm'])),
            ('diff', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('notifications', ['AmendmentNotification'])

        # Adding field 'NotificationType.diff'
        db.add_column('notifications_notificationtype', 'diff', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AmendmentNotification'
        db.delete_table('notifications_amendmentnotification')

        # Deleting field 'NotificationType.diff'
        db.delete_column('notifications_notificationtype', 'diff')
