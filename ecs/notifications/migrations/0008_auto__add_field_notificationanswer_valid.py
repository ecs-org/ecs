...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationAnswer.valid'
        db.add_column('notifications_notificationanswer', 'valid', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationAnswer.valid'
        db.delete_column('notifications_notificationanswer', 'valid')
