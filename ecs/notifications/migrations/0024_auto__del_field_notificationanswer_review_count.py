...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NotificationAnswer.review_count'
        db.delete_column('notifications_notificationanswer', 'review_count')


    def backwards(self, orm):
        
        # Adding field 'NotificationAnswer.review_count'
        db.add_column('notifications_notificationanswer', 'review_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
