...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SafetyNotification.reviewer'
        db.add_column('notifications_safetynotification', 'reviewer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SafetyNotification.reviewer'
        db.delete_column('notifications_safetynotification', 'reviewer_id')
    ...
    models = {
        ...
        'notifications.notificationanswer': {
            ...
            'executive_reviewer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
