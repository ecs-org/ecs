...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.default_response'
        db.add_column('notifications_notificationtype', 'default_response', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationType.default_response'
        db.delete_column('notifications_notificationtype', 'default_response')
