...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AmendmentNotification.diff'
        db.delete_column('notifications_amendmentnotification', 'diff')


    def backwards(self, orm):
        
        # We cannot add back in field 'AmendmentNotification.diff'
        raise RuntimeError(
            "Cannot reverse this migration. 'AmendmentNotification.diff' and its values cannot be restored.")
