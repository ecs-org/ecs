...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.grants_vote_extension'
        db.add_column('notifications_notificationtype', 'grants_vote_extension', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationType.grants_vote_extension'
        db.delete_column('notifications_notificationtype', 'grants_vote_extension')
