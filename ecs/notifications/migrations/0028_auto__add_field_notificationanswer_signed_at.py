...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationAnswer.signed_at'
        db.add_column('notifications_notificationanswer', 'signed_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationAnswer.signed_at'
        db.delete_column('notifications_notificationanswer', 'signed_at')
