...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.timestamp'
        db.add_column('notifications_notification', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Notification.user'
        db.add_column('notifications_notification', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.timestamp'
        db.delete_column('notifications_notification', 'timestamp')
