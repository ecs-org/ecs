...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationAnswer.is_final_version'
        db.add_column('notifications_notificationanswer', 'is_final_version', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'ProgressReportNotification.extension_of_vote_requested'
        db.delete_column('notifications_progressreportnotification', 'extension_of_vote_requested')


    def backwards(self, orm):
        
        # Deleting field 'NotificationAnswer.is_final_version'
        db.delete_column('notifications_notificationanswer', 'is_final_version')

        # Adding field 'ProgressReportNotification.extension_of_vote_requested'
        db.add_column('notifications_progressreportnotification', 'extension_of_vote_requested', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
