...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChecklistBillingState'
        db.create_table('billing_checklistbillingstate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('checklist', self.gf('django.db.models.fields.related.OneToOneField')(related_name='billing_state', unique=True, null=True, to=orm['core.Checklist'])),
            ('billed_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('billing', ['ChecklistBillingState'])


    def backwards(self, orm):
        
        # Deleting model 'ChecklistBillingState'
        db.delete_table('billing_checklistbillingstate')
    ...
    models = {
        ...
        'billing.checklistbillingstate': {
            ...
            'checklist': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'billing_state'", 'unique': 'True', 'null': 'True', 'to': "orm['core.Checklist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'billing.price': {
