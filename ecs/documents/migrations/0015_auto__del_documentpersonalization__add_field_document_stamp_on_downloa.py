...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.stamp_on_download'
        db.add_column('documents_document', 'stamp_on_download', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('documents_documentpersonalization', (
            ...
            ('id', self.gf('django.db.models.fields.SlugField')(default='406f72f6b0634fa4b570bcbbcd0ef365', max_length=36, primary_key=True, db_index=True)),
        ))
        db.send_create_signal('documents', ['DocumentPersonalization'])

        # Deleting field 'Document.stamp_on_download'
        db.delete_column('documents_document', 'stamp_on_download')
    ...
    models = {
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'4244c847a24f4db3b08bb0e530654e22'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
