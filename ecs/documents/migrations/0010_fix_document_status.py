...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Document.objects.filter(status__in=('uploaded', 'prime')).update(status='ready')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'d4d4f3a573c849b19278a32e10d90436'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
