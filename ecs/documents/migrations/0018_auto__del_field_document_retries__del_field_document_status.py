...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Document.retries'
        db.delete_column('documents_document', 'retries')

        # Deleting field 'Document.status'
        db.delete_column('documents_document', 'status')


    def backwards(self, orm):
        
        # Adding field 'Document.retries'
        db.add_column('documents_document', 'retries', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Document.status'
        db.add_column('documents_document', 'status', self.gf('django.db.models.fields.CharField')(default='new', max_length=15), keep_default=False)
    ...
    models = {
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'6ca7771d31894c80a76ec17a8571f7f7'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
