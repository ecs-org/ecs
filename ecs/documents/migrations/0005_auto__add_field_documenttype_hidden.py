...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentType.hidden'
        db.add_column('documents_documenttype', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentType.hidden'
        db.delete_column('documents_documenttype', 'hidden')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'a9c5d7832f5f47bcaebd802690155edc'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
