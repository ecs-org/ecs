...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Document.objects.filter(status__in=('indexing', 'indexed')).update(status='new')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'08728dfcbfda406cbb1f1e3951de7f59'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
