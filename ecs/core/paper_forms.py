...
FormInfo(SubmissionForm, fields=(
    ...
    FieldInfo('7.6', 'german_ethical_info', _(u'ethical considerations')),
    ...
    FieldInfo('7.8', 'german_recruitment_info', _(u'Description of the recruitment process')),
    FieldInfo('7.9', 'german_consent_info', _(u'Approach at test center(s), for informing and  obtaining an informed consent of candidates')),
    FieldInfo('7.10', 'german_risks_info', _(u'Risk assessment')),
    ...
    FieldInfo('7.17', 'german_aftercare_info', _(u'Plan for treatment or care after the person has completed their participation in the study')),
    ...
    FieldInfo('7.20', 'german_dataaccess_info', _(u'Agreement on access of the examiner(s) to data, publication guidelines, etc')),
    FieldInfo('7.21', 'german_financing_info', _(u'Financing of the study and information on financial or other interests of the examiner')),
    FieldInfo('7.22', 'german_additional_info', _(u'additional information')),
    ...
    FieldInfo(None, 'sponsor_agrees_to_publishing', None, short_label=
        _(u'The sponsor agrees with the publication of following data by the Ethics Commission as appropiate: EC-Number, Submission Date, Project Title, Main Investigator, Sponsor/CRO and the Centres'),
        help_text= _(u'(Die Zustimmung zum Register ist verpflichtend, wenn die MUW Sponsor ist.)')),
))
