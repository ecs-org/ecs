...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistQuestion.number'
        db.add_column('core_checklistquestion', 'number', self.gf('django.db.models.fields.CharField')(max_length=5, null=True), keep_default=False)

        # Adding unique constraint on 'ChecklistQuestion', fields ['blueprint', 'number']
        db.create_unique('core_checklistquestion', ['blueprint_id', 'number'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ChecklistQuestion', fields ['blueprint', 'number']
        db.delete_unique('core_checklistquestion', ['blueprint_id', 'number'])

        # Deleting field 'ChecklistQuestion.number'
        db.delete_column('core_checklistquestion', 'number')
    ...
    models = {
        ...
        'core.checklistquestion': {
            ...
            'number': ('django.db.models.fields.CharField', [], {'max_length': '5', 'null': 'True'}),
