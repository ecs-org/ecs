...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdvancedSettings.default_contact'
        db.alter_column('core_advancedsettings', 'default_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'AdvancedSettings.default_contact'
        db.alter_column('core_advancedsettings', 'default_contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 4, 16, 26, 12, 177236)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
