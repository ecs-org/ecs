...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.submission_form'
        db.alter_column('core_vote', 'submission_form_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.SubmissionForm']))


    def backwards(self, orm):
        
        # Changing field 'Vote.submission_form'
        db.alter_column('core_vote', 'submission_form_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SubmissionForm']))
