...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.invite_primary_investigator_to_meeting'
        db.add_column('core_submission', 'invite_primary_investigator_to_meeting', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Submission.sponsor_required_for_next_meeting'
        db.add_column('core_submission', 'sponsor_required_for_next_meeting', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Submission.invite_primary_investigator_to_meeting'
        db.delete_column('core_submission', 'invite_primary_investigator_to_meeting')
