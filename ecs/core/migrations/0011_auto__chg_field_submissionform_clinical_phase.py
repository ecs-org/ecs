...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.clinical_phase'
        db.alter_column('core_submissionform', 'clinical_phase', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.clinical_phase'
        db.alter_column('core_submissionform', 'clinical_phase', self.gf('django.db.models.fields.CharField')(max_length=10))
