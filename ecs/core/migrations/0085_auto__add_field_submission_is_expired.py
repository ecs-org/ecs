...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.is_expired'
        db.add_column('core_submission', 'is_expired', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.is_expired'
        db.delete_column('core_submission', 'is_expired')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 20, 19, 16, 36, 482396)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
