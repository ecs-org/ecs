...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.created_at'
        db.alter_column('core_submissionform', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.created_at'
        db.alter_column('core_submissionform', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
