...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistQuestion.inverted'
        db.add_column('core_checklistquestion', 'inverted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistQuestion.inverted'
        db.delete_column('core_checklistquestion', 'inverted')
