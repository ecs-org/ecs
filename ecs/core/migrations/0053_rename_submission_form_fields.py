...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('core_submissionform', 'transient', 'is_transient')
        db.rename_column('core_submissionform', 'acknowledged', 'is_acknowledged')

    def backwards(self, orm):
        db.rename_column('core_submissionform', 'is_transient')
        db.rename_column('core_submissionform', 'is_acknowledged')
