...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.study_plan_dataprotection_reason'
        db.alter_column('core_submissionform', 'study_plan_dataprotection_reason', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'SubmissionForm.study_plan_dataprotection_dvr'
        db.alter_column('core_submissionform', 'study_plan_dataprotection_dvr', self.gf('django.db.models.fields.CharField')(max_length=180, null=True))


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.study_plan_dataprotection_reason'
        db.alter_column('core_submissionform', 'study_plan_dataprotection_reason', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'SubmissionForm.study_plan_dataprotection_dvr'
        db.alter_column('core_submissionform', 'study_plan_dataprotection_dvr', self.gf('django.db.models.fields.CharField')(max_length=180))
