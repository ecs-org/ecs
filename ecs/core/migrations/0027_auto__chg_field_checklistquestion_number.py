...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChecklistQuestion.number'
        db.alter_column('core_checklistquestion', 'number', self.gf('django.db.models.fields.CharField')(max_length=5))


    def backwards(self, orm):
        
        # Changing field 'ChecklistQuestion.number'
        db.alter_column('core_checklistquestion', 'number', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))
