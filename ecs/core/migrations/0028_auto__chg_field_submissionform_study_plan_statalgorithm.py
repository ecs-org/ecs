...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_submissionform', 'study_plan_statalgorithm', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    models = {
        ...
        'meetings.meeting': {
            ...
            'expedited_submissions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'expedited_meetings'", 'symmetrical': 'False', 'to': "orm['core.Submission']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
