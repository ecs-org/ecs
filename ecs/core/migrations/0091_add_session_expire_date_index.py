...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        if not db.execute("select to_regclass('django_session_expire_date')")[0][0]:
            db.execute('''
    ...
    models = {
        ...
        'core.mysubmission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['core.Submission']"}),
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'32107505e41e434ca0c65b63359e0b89'", 'unique': 'True', 'max_length': '36'}),
