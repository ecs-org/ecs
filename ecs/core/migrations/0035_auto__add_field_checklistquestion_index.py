...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistQuestion.index'
        db.add_column('core_checklistquestion', 'index', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistQuestion.index'
        db.delete_column('core_checklistquestion', 'index')
