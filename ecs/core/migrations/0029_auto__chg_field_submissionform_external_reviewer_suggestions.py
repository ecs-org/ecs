...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.external_reviewer_suggestions'
        db.alter_column('core_submissionform', 'external_reviewer_suggestions', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.external_reviewer_suggestions'
        db.alter_column('core_submissionform', 'external_reviewer_suggestions', self.gf('django.db.models.fields.TextField')(null=True))
