...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.executive_comment'
        db.add_column('core_submission', 'executive_comment', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.executive_comment'
        db.delete_column('core_submission', 'executive_comment')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 9, 17, 49, 43, 576319)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
