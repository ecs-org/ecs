...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionForm.invoice'
        db.delete_column('core_submissionform', 'invoice_id')


    def backwards(self, orm):
        
        # Adding field 'SubmissionForm.invoice'
        db.add_column('core_submissionform', 'invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='charged_submission_forms', null=True, to=orm['auth.User']), keep_default=False)
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 21, 21, 16, 8, 432461)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
