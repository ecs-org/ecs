...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for s in orm.Submission.objects.all():
            s.next_meeting = None
            next = s.meetings.filter(start__gt=datetime.datetime.now()).order_by('start')[:1]
            if next:
                s.next_meeting = next[0]
            s.save()
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 1, 21, 9, 11, 443597)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
