...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.valid_until'
        db.add_column('core_vote', 'valid_until', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.valid_until'
        db.delete_column('core_vote', 'valid_until')
