...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.study_plan_multiple_test'
        db.add_column('core_submissionform', 'study_plan_multiple_test', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'SubmissionForm.study_plan_multiple_test_correction_algorithm'
        db.alter_column('core_submissionform', 'study_plan_multiple_test_correction_algorithm', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.study_plan_multiple_test'
        db.delete_column('core_submissionform', 'study_plan_multiple_test')
