...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Submission', fields ['workflow_lane']
        db.create_index('core_submission', ['workflow_lane'])


    def backwards(self, orm):
        
        # Removing index on 'Submission', fields ['workflow_lane']
        db.delete_index('core_submission', ['workflow_lane'])
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 20, 10, 31, 42, 926073)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
