...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EthicsCommission.vote_receiver'
        db.add_column('core_ethicscommission', 'vote_receiver', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EthicsCommission.vote_receiver'
        db.delete_column('core_ethicscommission', 'vote_receiver')
    ...
    models = {
        ...
        'core.ethicscommission': {
            ...
            'vote_receiver': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 17, 15, 51, 34, 244162)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
