...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.insurance_not_required'
        db.add_column('core_submissionform', 'insurance_not_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.insurance_not_required'
        db.delete_column('core_submissionform', 'insurance_not_required')
