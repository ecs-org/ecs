...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for s in orm.Submission.objects.all():
            s.presenter = s.current_submission_form.presenter
            s.susar_presenter = s.current_submission_form.susar_presenter
            s.save()
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 16, 24, 29, 828129)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
