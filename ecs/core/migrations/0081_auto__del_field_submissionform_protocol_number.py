...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'SubmissionForm.protocol_number'
        raise RuntimeError(
            "Cannot reverse this migration. 'SubmissionForm.protocol_number' and its values cannot be restored.")
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 19, 12, 52, 28, 823473)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
