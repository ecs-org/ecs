...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.transient'
        db.add_column('core_submissionform', 'transient', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.transient'
        db.delete_column('core_submissionform', 'transient')
