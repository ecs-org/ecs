...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.project_type_nursing_study'
        db.add_column('core_submissionform', 'project_type_nursing_study', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.project_type_nursing_study'
        db.delete_column('core_submissionform', 'project_type_nursing_study')
