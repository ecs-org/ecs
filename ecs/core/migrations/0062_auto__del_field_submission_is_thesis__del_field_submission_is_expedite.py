...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Submission.is_thesis'
        db.delete_column('core_submission', 'is_thesis')

        # Deleting field 'Submission.is_expedited'
        db.delete_column('core_submission', 'is_expedited')

        # Deleting field 'Submission.is_mpg'
        db.delete_column('core_submission', 'is_mpg')

        # Deleting field 'Submission.is_amg'
        db.delete_column('core_submission', 'is_amg')

        # Deleting field 'Submission.is_retrospective'
        db.delete_column('core_submission', 'is_retrospective')

        # Adding field 'Submission.workflow_lane'
        db.add_column('core_submission', 'workflow_lane', self.gf('django.db.models.fields.SmallIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Submission.is_thesis'
        db.add_column('core_submission', 'is_thesis', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Submission.is_expedited'
        db.add_column('core_submission', 'is_expedited', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Submission.is_mpg'
        db.add_column('core_submission', 'is_mpg', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Submission.is_amg'
        db.add_column('core_submission', 'is_amg', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Adding field 'Submission.is_retrospective'
        db.add_column('core_submission', 'is_retrospective', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Submission.workflow_lane'
        db.delete_column('core_submission', 'workflow_lane')
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'external_reviewer_suggestions': ('django.db.models.fields.TextField', [], {}),
            ...
            'susar_presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'susar_presented_submission_forms'", 'to': "orm['auth.User']"})
        },
        'countries.country': {
        ...
        'meetings.timetableentry': {
            ...
            'is_sponsor_invited': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
