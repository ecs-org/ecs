...
class Migration(DataMigration):
    ...
    models = {
        ...
        'core.advancedsettings': {
            ...
            'default_contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'core.ethicscommission': {
            ...
            'vote_receiver': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
        ...
        'core.expeditedreviewcategory': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'expedited_review_categories'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        ...
        'core.investigator': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'investigations'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        ...
        'core.medicalcategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'medical_categories'", 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        'core.mysubmission': {
            'Meta': {'object_name': 'MySubmission', 'managed': 'False'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.submission': {
            ...
            'befangene': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'befangen_for_submissions'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            ...
            'external_reviewers': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'external_review_submission_set'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            ...
            'presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'presented_submissions'", 'to': u"orm['auth.User']"}),
            ...
            'susar_presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'susar_presented_submissions'", 'to': u"orm['auth.User']"}),
            'valid_until': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'workflow_lane': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'db_index': 'True'})
        },
        'core.submissionform': {
            ...
            'current_pending_vote': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_currently_pending_for'", 'unique': 'True', 'null': 'True', 'to': u"orm['votes.Vote']"}),
            'current_published_vote': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_currently_published_for'", 'unique': 'True', 'null': 'True', 'to': u"orm['votes.Vote']"}),
            'date_of_receipt': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'submission_forms'", 'null': 'True', 'to': u"orm['documents.Document']"}),
            ...
            'pdf_document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'submission_form'", 'unique': 'True', 'null': 'True', 'to': u"orm['documents.Document']"}),
            ...
            'presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'presented_submission_forms'", 'to': u"orm['auth.User']"}),
            ...
            'sponsor': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sponsored_submission_forms'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'study_plan_alpha_sided': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submitted_submission_forms'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'substance_p_c_t_countries': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['countries.Country']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'substance_registered_in_countries': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'submission_forms'", 'blank': 'True', 'db_table': "'submission_registered_countries'", 'to': u"orm['countries.Country']"})
        },
        'core.temporaryauthorization': {
            'Meta': {'object_name': 'TemporaryAuthorization'},
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'temp_auth'", 'to': "orm['core.Submission']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'temp_submission_auth'", 'to': u"orm['auth.User']"})
        },
        u'countries.country': {
        ...
        u'documents.document': {
            ...
            'doctype': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['documents.DocumentType']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'replaces_document': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['documents.Document']", 'null': 'True', 'blank': 'True'}),
            'stamp_on_download': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'87103a8ec0544325a7754595606c7f11'", 'unique': 'True', 'max_length': '36'}),
        ...
        u'meetings.meeting': {
            ...
            'expedited_reviewer_invitation_sent_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'expedited_reviewer_invitation_sent_for': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'optimization_task_id': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'protocol_sent_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'started': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'submissions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'meetings'", 'symmetrical': 'False', 'through': u"orm['meetings.TimetableEntry']", 'to': "orm['core.Submission']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
        u'meetings.timetableentry': {
            'Meta': {'unique_together': "(('meeting', 'timetable_index'),)", 'object_name': 'TimetableEntry'},
            ...
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timetable_entries'", 'to': u"orm['meetings.Meeting']"}),
        ...
        u'votes.vote': {
            ...
            'changed_after_voting': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'top': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'vote'", 'unique': 'True', 'null': 'True', 'to': u"orm['meetings.TimetableEntry']"}),
            'upgrade_for': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'previous'", 'unique': 'True', 'null': 'True', 'to': u"orm['votes.Vote']"}),
