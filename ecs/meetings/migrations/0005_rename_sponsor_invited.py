...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('meetings_timetableentry', 'sponsor_invited', 'is_sponsor_invited')


    def backwards(self, orm):
        db.rename_column('meetings_timetableentry', 'is_sponsor_invited', 'sponsor_invited')
