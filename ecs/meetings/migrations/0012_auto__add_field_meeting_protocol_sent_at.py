...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.protocol_sent_at'
        db.add_column('meetings_meeting', 'protocol_sent_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.protocol_sent_at'
        db.delete_column('meetings_meeting', 'protocol_sent_at')
