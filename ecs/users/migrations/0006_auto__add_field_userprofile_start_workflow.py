...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.start_workflow'
        db.add_column('users_userprofile', 'start_workflow', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.start_workflow'
        db.delete_column('users_userprofile', 'start_workflow')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'43683e56f1904a34a6370a60fda30dd1'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
