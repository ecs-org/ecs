...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSettings.task_filter_tmp'
        db.alter_column('users_usersettings', 'task_filter_tmp', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'UserSettings.task_filter_tmp'
        db.alter_column('users_usersettings', 'task_filter_tmp', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6dbfbbd8dd284e40bebe19c91d67ef0f'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
        ...
        'users.usersettings': {
            ...
            'task_filter_tmp': ('django.db.models.fields.TextField', [], {}),
