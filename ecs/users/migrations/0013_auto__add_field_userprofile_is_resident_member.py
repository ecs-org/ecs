...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.is_resident_member'
        db.add_column('users_userprofile', 'is_resident_member', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.is_resident_member'
        db.delete_column('users_userprofile', 'is_resident_member')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1d2c8a757e314cc6a8d9952f9b1f6692'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
