...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'UserSettings.task_filter_tmp'
        raise RuntimeError(
            "Cannot reverse this migration. 'UserSettings.task_filter_tmp' and its values cannot be restored.")
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c91057c698c54feeb9ad1daef2449892'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
