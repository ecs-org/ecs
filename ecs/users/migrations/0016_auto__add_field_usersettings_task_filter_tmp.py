...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.task_filter_tmp'
        db.add_column('users_usersettings', 'task_filter_tmp', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSettings.task_filter_tmp'
        db.delete_column('users_usersettings', 'task_filter_tmp')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'50461fdbdee64ad8a1c0b7122b70c3e2'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
        ...
        'users.usersettings': {
            ...
            'task_filter_tmp': ('django.db.models.fields.TextField', [], {'null': 'True'}),
