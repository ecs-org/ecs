...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'is_developer',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('users_userprofile', 'is_developer')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'e030496d397b4e3d8c4c03eaf5eb9635'", 'unique': 'True', 'max_length': '32'})
        },
        'users.loginhistory': {
