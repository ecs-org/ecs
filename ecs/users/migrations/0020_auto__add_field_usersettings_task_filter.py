...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_usersettings', 'task_filter', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'af441a150f714563a63fedea77ef4235'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
