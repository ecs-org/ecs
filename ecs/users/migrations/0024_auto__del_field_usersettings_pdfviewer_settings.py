...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'UserSettings.pdfviewer_settings'
        raise RuntimeError(
            "Cannot reverse this migration. 'UserSettings.pdfviewer_settings' and its values cannot be restored.")
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f40b752c90ab4f448666a2c01c73dcae'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
