...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('users_userprofile', 'phantom', 'is_phantom')
        db.rename_column('users_userprofile', 'approved_by_office', 'is_approved_by_office')
        db.rename_column('users_userprofile', 'indisposed', 'is_indisposed')
        db.rename_column('users_userprofile', 'board_member', 'is_board_member')
        db.rename_column('users_userprofile', 'executive_board_member', 'is_executive_board_member')
        db.rename_column('users_userprofile', 'thesis_review', 'is_thesis_reviewer')
        db.rename_column('users_userprofile', 'insurance_review', 'is_insurance_reviewer')
        db.rename_column('users_userprofile', 'expedited_review', 'is_expedited_reviewer')
        db.rename_column('users_userprofile', 'internal', 'is_internal')
        db.rename_column('users_userprofile', 'help_writer', 'is_help_writer')
        db.rename_column('users_invitation', 'accepted', 'is_accepted')

    def backwards(self, orm):
        db.rename_column('users_userprofile', 'is_phantom', 'phantom')
        db.rename_column('users_userprofile', 'is_approved_by_office', 'approved_by_office')
        db.rename_column('users_userprofile', 'is_indisposed', 'indisposed')
        db.rename_column('users_userprofile', 'is_board_member', 'board_member')
        db.rename_column('users_userprofile', 'is_executive_board_member', 'executive_board_member')
        db.rename_column('users_userprofile', 'is_thesis_reviewer', 'thesis_review')
        db.rename_column('users_userprofile', 'is_insurance_reviewer', 'insurance_review')
        db.rename_column('users_userprofile', 'is_expedited_reviewer', 'expedited_review')
        db.rename_column('users_userprofile', 'is_internal', 'internal')
        db.rename_column('users_userprofile', 'is_help_writer', 'help_writer')
        db.rename_column('users_invitation', 'is_accepted', 'accepted')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'61dac72aeaab4de581f850476b629afa'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
