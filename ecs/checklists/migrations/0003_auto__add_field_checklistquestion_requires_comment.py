...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistQuestion.requires_comment'
        db.add_column('checklists_checklistquestion', 'requires_comment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistQuestion.requires_comment'
        db.delete_column('checklists_checklistquestion', 'requires_comment')
