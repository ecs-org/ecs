...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.reviewer_is_anonymous'
        db.add_column('checklists_checklistblueprint', 'reviewer_is_anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.reviewer_is_anonymous'
        db.delete_column('checklists_checklistblueprint', 'reviewer_is_anonymous')
