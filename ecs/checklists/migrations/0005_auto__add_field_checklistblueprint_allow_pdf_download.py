...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.allow_pdf_download'
        db.add_column('checklists_checklistblueprint', 'allow_pdf_download', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.allow_pdf_download'
        db.delete_column('checklists_checklistblueprint', 'allow_pdf_download')
