...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Token.created_at'
        db.alter_column('workflow_token', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Token.created_at'
        db.alter_column('workflow_token', 'created_at', self.gf('django.db.models.fields.DateTimeField')())
