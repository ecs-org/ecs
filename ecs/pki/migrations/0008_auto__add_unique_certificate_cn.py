...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Certificate', fields ['cn']
        db.create_unique('pki_certificate', ['cn'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Certificate', fields ['cn']
        db.delete_unique('pki_certificate', ['cn'])
