...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Certificate.fingerprint'
        db.alter_column('pki_certificate', 'fingerprint', self.gf('django.db.models.fields.CharField')(max_length=60))


    def backwards(self, orm):
        
        # Changing field 'Certificate.fingerprint'
        db.alter_column('pki_certificate', 'fingerprint', self.gf('django.db.models.fields.CharField')(max_length=50))
