...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.insurance_review_required'
        db.add_column('votes_vote', 'insurance_review_required', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.insurance_review_required'
        db.delete_column('votes_vote', 'insurance_review_required')
