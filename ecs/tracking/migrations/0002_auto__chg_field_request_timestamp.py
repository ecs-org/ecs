...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Request.timestamp'
        db.alter_column('tracking_request', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Request.timestamp'
        db.alter_column('tracking_request', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
