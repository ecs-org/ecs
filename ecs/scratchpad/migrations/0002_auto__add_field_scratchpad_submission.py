...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScratchPad.submission'
        db.add_column('scratchpad_scratchpad', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Submission'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ScratchPad.submission'
        db.delete_column('scratchpad_scratchpad', 'submission_id')
