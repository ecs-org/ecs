...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocStash.owner'
        db.add_column('docstash_docstash', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'DocStash.owner'
        db.delete_column('docstash_docstash', 'owner_id')
