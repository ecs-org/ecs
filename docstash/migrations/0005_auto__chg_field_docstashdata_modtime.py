...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocStashData.modtime'
        db.alter_column('docstash_docstashdata', 'modtime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'DocStashData.modtime'
        db.alter_column('docstash_docstashdata', 'modtime', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'docstash.docstashdata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modtime': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
