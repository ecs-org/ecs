...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DocStashData.name'
        db.alter_column('docstash_docstashdata', 'name', self.gf('django.db.models.fields.TextField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'DocStashData.name'
        db.alter_column('docstash_docstashdata', 'name', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True))
