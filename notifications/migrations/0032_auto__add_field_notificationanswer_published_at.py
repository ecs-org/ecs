...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationAnswer.published_at'
        db.add_column('notifications_notificationanswer', 'published_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationAnswer.published_at'
        db.delete_column('notifications_notificationanswer', 'published_at')
