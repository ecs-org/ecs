...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_notificationanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notification', self.gf('django.db.models.fields.related.OneToOneField')(related_name='answer', unique=True, to=orm['notifications.Notification'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('notifications', ['NotificationAnswer'])


    def backwards(self, orm):
        
        # Deleting model 'NotificationAnswer'
        db.delete_table('notifications_notificationanswer')
