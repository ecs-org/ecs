...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.finishes_study'
        db.add_column('notifications_notificationtype', 'finishes_study', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationType.finishes_study'
        db.delete_column('notifications_notificationtype', 'finishes_study')
