...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for at in orm['audit.AuditTrail'].objects.filter(content_type=ct):
            ...
            at_data = json.loads(at.data)[0]['fields']
            data = [{
                'pk': at.object_id,
                'model': 'notifications.notificationanswer',
                'fields': {
                    'text': at_data['text'],
                },
            }]
            reversion.models.Version.objects.create(
                revision=rev,
                object_id=at.object_id,
                content_type_id=ct.id,
                format='json',
                serialized_data=json.dumps(data),
                object_repr=repr('NotificationAnswer ID {0}'.format(at.object_id)),
            )
    ...
    complete_apps = ['audit', 'notifications']
