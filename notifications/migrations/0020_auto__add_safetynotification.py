...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SafetyNotification'
        db.create_table('notifications_safetynotification', (
            ...
            ('safety_type', self.gf('django.db.models.fields.CharField')(max_length=6, db_index=True)),
        ))
        db.send_create_signal('notifications', ['SafetyNotification'])


    def backwards(self, orm):
        
        # Deleting model 'SafetyNotification'
        db.delete_table('notifications_safetynotification')
