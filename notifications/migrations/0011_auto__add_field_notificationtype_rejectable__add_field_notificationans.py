...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.rejectable'
        db.add_column('notifications_notificationtype', 'rejectable', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'NotificationAnswer.rejected'
        db.add_column('notifications_notificationanswer', 'rejected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationType.rejectable'
        db.delete_column('notifications_notificationtype', 'rejectable')

        # Deleting field 'NotificationAnswer.rejected'
        db.delete_column('notifications_notificationanswer', 'rejected')
