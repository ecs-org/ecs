...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompletionReportNotification.study_started'
        db.add_column('notifications_completionreportnotification', 'study_started', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'ProgressReportNotification.study_started'
        db.add_column('notifications_progressreportnotification', 'study_started', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompletionReportNotification.study_started'
        db.delete_column('notifications_completionreportnotification', 'study_started')

        # Deleting field 'ProgressReportNotification.study_started'
        db.delete_column('notifications_progressreportnotification', 'study_started')
    ...
    models = {
        ...
        'notifications.notificationtype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '80'}),
            'rejectable': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
