...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SafetyNotification.is_acknowledged'
        db.add_column('notifications_safetynotification', 'is_acknowledged', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SafetyNotification.is_acknowledged'
        db.delete_column('notifications_safetynotification', 'is_acknowledged')
    ...
    models = {
        ...
        'notifications.notification': {
            ...
            'date_of_receipt': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'needs_executive_review': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
