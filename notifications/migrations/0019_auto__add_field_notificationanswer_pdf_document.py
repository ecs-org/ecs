...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationAnswer.pdf_document'
        db.add_column('notifications_notificationanswer', 'pdf_document', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_notification_answer', unique=True, null=True, to=orm['documents.Document']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationAnswer.pdf_document'
        db.delete_column('notifications_notificationanswer', 'pdf_document_id')
