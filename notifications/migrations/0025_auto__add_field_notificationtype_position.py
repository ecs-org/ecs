...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.position'
        db.add_column('notifications_notificationtype', 'position', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotificationType.position'
        db.delete_column('notifications_notificationtype', 'position')
