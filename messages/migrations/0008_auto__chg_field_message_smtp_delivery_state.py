...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.smtp_delivery_state'
        db.alter_column('messages_message', 'smtp_delivery_state', self.gf('django.db.models.fields.CharField')(max_length=7))
    
    
    def backwards(self, orm):
        
        # Changing field 'Message.smtp_delivery_state'
        db.alter_column('messages_message', 'smtp_delivery_state', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        'messages.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c9abffb08b884ddc8cb38ba2c70f19b5'", 'max_length': '32', 'db_index': 'True'})
        },
        'messages.thread': {
