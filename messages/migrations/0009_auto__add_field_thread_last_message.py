...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.last_message'
        db.add_column('messages_thread', 'last_message', self.gf('django.db.models.fields.related.OneToOneField')(related_name='head', unique=True, null=True, to=orm['messages.Message']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.last_message'
        db.delete_column('messages_thread', 'last_message_id')
    ...
    models = {
        ...
        'messages.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4ef4f207427e47c480e6c6d7d7aed159'", 'max_length': '32', 'db_index': 'True'})
        },
        'messages.thread': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'head'", 'unique': 'True', 'null': 'True', 'to': "orm['messages.Message']"}),
        ...
        'workflow.edge': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'negated': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
