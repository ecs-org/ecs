...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.uuid'
        db.add_column('messages_message', 'uuid', self.gf('django.db.models.fields.CharField')(default='28dbf659408e47a59bcced297161b269', max_length=32, db_index=True), keep_default=False)

        # Adding index on 'Message', fields ['smtp_delivery_state']
        db.create_index('messages_message', ['smtp_delivery_state'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'Message.uuid'
        db.delete_column('messages_message', 'uuid')

        # Removing index on 'Message', fields ['smtp_delivery_state']
        db.delete_index('messages_message', ['smtp_delivery_state'])
    ...
    models = {
        ...
        'messages.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'26ec437ca3eb4120828355dee19733b3'", 'max_length': '32', 'db_index': 'True'})
        },
        'messages.thread': {
