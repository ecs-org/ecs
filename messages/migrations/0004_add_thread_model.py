...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('messages_thread', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outgoing_threads', to=orm['auth.User'])),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Submission'], null=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('closed_by_receiver', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incoming_threads', to=orm['auth.User'])),
            ('closed_by_sender', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('messages', ['Thread'])

        # Deleting field 'Message.task'
        db.delete_column('messages_message', 'task_id')

        # Deleting field 'Message.submission'
        db.delete_column('messages_message', 'submission_id')

        # Deleting field 'Message.subject'
        db.delete_column('messages_message', 'subject')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Message.task'
        db.add_column('messages_message', 'task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Task'], null=True), keep_default=False)

        # Adding field 'Message.submission'
        db.add_column('messages_message', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Submission'], null=True), keep_default=False)

        # Adding field 'Message.subject'
        db.add_column('messages_message', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Changing field 'Message.thread'
        db.alter_column('messages_message', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['messages.Message']))
    ...
    models = {
        ...
        'messages.message': {
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'null': 'True', 'to': "orm['messages.Thread']"}),
