...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('messages_message', 'thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', null=True, to=orm['messages.Message']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Message.thread'
        db.delete_column('messages_message', 'thread_id')
    ...
    models = {
        ...
        'messages.message': {
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'null': 'True', 'to': "orm['messages.Message']"}),
