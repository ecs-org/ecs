...
urlpatterns = patterns('ecs.tasks.views',
    ...
    url(r'^task/(?P<task_pk>\d+)/accept/full/$', 'accept_task', {'full': True}),
    url(r'^task/(?P<task_pk>\d+)/decline/$', 'decline_task'),
    url(r'^task/(?P<task_pk>\d+)/decline/full/$', 'decline_task', {'full': True}),
    url(r'^task/(?P<task_pk>\d+)/manage/$', 'manage_task'),
    url(r'^task/(?P<task_pk>\d+)/manage/full/$', 'manage_task', {'full': True}),
