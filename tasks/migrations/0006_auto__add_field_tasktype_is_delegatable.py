...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskType.is_delegatable'
        db.add_column('tasks_tasktype', 'is_delegatable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TaskType.is_delegatable'
        db.delete_column('tasks_tasktype', 'is_delegatable')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'expedited_review_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.ExpeditedReviewCategory']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tasks.tasktype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_delegatable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
