...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.deleted_at'
        db.add_column('tasks_task', 'deleted_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.deleted_at'
        db.delete_column('tasks_task', 'deleted_at')
