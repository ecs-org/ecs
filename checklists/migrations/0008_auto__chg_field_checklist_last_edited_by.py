...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Checklist.last_edited_by'
        db.alter_column('checklists_checklist', 'last_edited_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Checklist.last_edited_by'
        db.alter_column('checklists_checklist', 'last_edited_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
