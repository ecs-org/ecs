...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ('core', '0060_extract_checklists'),
    )

    def forwards(self, orm):
        # Adding unique constraint on 'ChecklistQuestion', fields ['blueprint', 'number']
        db.create_unique('checklists_checklistquestion', ['blueprint_id', 'number'])

    def backwards(self, orm):
        # Removing unique constraint on 'ChecklistQuestion', fields ['blueprint', 'number']
        db.delete_unique('checklists_checklistquestion', ['blueprint_id', 'number'])
