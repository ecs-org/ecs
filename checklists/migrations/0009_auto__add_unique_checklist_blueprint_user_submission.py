...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Checklist', fields ['blueprint', 'user', 'submission']
        db.create_unique('checklists_checklist', ['blueprint_id', 'user_id', 'submission_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Checklist', fields ['blueprint', 'user', 'submission']
        db.delete_unique('checklists_checklist', ['blueprint_id', 'user_id', 'submission_id'])
    ...
    models = {
        ...
        'checklists.checklist': {
            'Meta': {'unique_together': "(('blueprint', 'submission', 'user'),)", 'object_name': 'Checklist'},
            'blueprint': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'checklists'", 'to': "orm['checklists.ChecklistBlueprint']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edited_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edited_checklists'", 'to': "orm['auth.User']"}),
            'pdf_document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'checklist'", 'unique': 'True', 'null': 'True', 'to': "orm['documents.Document']"}),
        ...
        'checklists.checklistanswer': {
            'Meta': {'ordering': "('question__blueprint', 'question__index')", 'object_name': 'ChecklistAnswer'},
            'answer': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'checklist': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'to': "orm['checklists.Checklist']"}),
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['checklists.ChecklistQuestion']"})
        },
        'checklists.checklistblueprint': {
            'Meta': {'object_name': 'ChecklistBlueprint'},
            'allow_pdf_download': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'billing_required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'multiple': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'reviewer_is_anonymous': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50', 'db_index': 'True'})
        },
        'checklists.checklistquestion': {
            'Meta': {'ordering': "('blueprint', 'index')", 'unique_together': "(('blueprint', 'number'),)", 'object_name': 'ChecklistQuestion'},
            'blueprint': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['checklists.ChecklistBlueprint']"}),
            ...
            'number': ('django.db.models.fields.CharField', [], {'max_length': '5', 'db_index': 'True'}),
