...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.last_edited_by'
        db.add_column('checklists_checklist', 'last_edited_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edited_checklists', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Checklist.last_edited_by'
        db.delete_column('checklists_checklist', 'last_edited_by_id')
    ...
    models = {
        ...
        'checklists.checklist': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_edited_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'edited_checklists'", 'null': 'True', 'to': "orm['auth.User']"}),
