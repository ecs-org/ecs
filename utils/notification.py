...
def send_submission_notifications(submission, subject, text, recipients, username='root'):
...
def send_submission_creation(sf, registered_recipients, username='root'):
    ...
    send_submission_notifications(sf.submission, subject, text, registered_recipients, username=username)
...
def send_submission_invitation(sf, unregistered_recipients, username='root'):
    ...
    subject = u'Neue Studie EK-Nr. %s' % (sf.submission.ec_number)
    send_submission_notifications(sf.submission, subject, text, unregistered_recipients, username=username)
...
def send_submission_change(sf, recipients, username='root'):
    ...
    send_submission_notifications(sf.submission, subject, text, recipients, username=username)
