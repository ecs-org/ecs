...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'fastlane.fastlanemeeting': {
            'Meta': {'object_name': 'FastLaneMeeting'},
            'ended': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {}),
            'started': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'submissions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'fast_lane_meetings'", 'symmetrical': 'False', 'through': "orm['fastlane.FastLaneTop']", 'to': "orm['core.Submission']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
        'fastlane.fastlanetop': {
            'Meta': {'object_name': 'FastLaneTop'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
