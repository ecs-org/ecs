...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FastLaneTop.submission'
        db.alter_column('fastlane_fastlanetop', 'submission_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['core.Submission']))


    def backwards(self, orm):
        
        # Changing field 'FastLaneTop.submission'
        db.alter_column('fastlane_fastlanetop', 'submission_id', self.gf('django.db.models.fields.related.ForeignKey')(unique=True, to=orm['core.Submission']))
