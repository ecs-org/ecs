...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssignedFastLaneCategory.meeting'
        db.add_column('fastlane_assignedfastlanecategory', 'meeting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='categories', null=True, to=orm['fastlane.FastLaneMeeting']), keep_default=False)

        # Removing M2M table for field tops on 'AssignedFastLaneCategory'
        db.delete_table('fastlane_assignedfastlanecategory_tops')

        # Adding unique constraint on 'AssignedFastLaneCategory', fields ['category', 'meeting']
        db.create_unique('fastlane_assignedfastlanecategory', ['category_id', 'meeting_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AssignedFastLaneCategory', fields ['category', 'meeting']
        db.delete_unique('fastlane_assignedfastlanecategory', ['category_id', 'meeting_id'])

        # Deleting field 'AssignedFastLaneCategory.meeting'
        db.delete_column('fastlane_assignedfastlanecategory', 'meeting_id')
