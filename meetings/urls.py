...
urlpatterns = patterns('ecs.meetings.views',
    ...
    url(r'^meeting/(?P<meeting_pk>\d+)/submissions/$', 'submission_list'),
    url(r'^meeting/(?P<meeting_pk>\d+)/documents/zip/$', 'download_zipped_documents'),
    url(r'^meeting/(?P<meeting_pk>\d+)/documents/(?P<submission_pk>\d+)/zip/$', 'download_zipped_documents'),
