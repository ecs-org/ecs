...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # XXX: Postgres 9.1 doesn't support the ALTER TABLE ... ALTER CONSTRAINT
        # syntax yet, so we have to recreate the unique constraint.
        
        db.delete_unique('meetings_timetableentry', ['meeting_id', 'timetable_index'])

        constraint_name = db.create_index_name('meetings_timetableentry',
            ['meeting_id', 'timetable_index'], suffix="_uniq")

        db.execute('''
            ALTER TABLE meetings_timetableentry
                ADD CONSTRAINT {} UNIQUE (meeting_id, timetable_index)
                    DEFERRABLE INITIALLY DEFERRED
        '''.format(db.quote_name(constraint_name),))


    def backwards(self, orm):
        
        db.delete_unique('meetings_timetableentry', ['meeting_id', 'timetable_index'])
        db.create_unique('meetings_timetableentry', ['meeting_id', 'timetable_index'])
    ...
    models = {
        ...
        'meetings.assignedmedicalcategory': {
            ...
            'board_member': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_medical_categories'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'meetings.participation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignored_for_optimization': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
