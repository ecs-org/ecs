...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TimetableEntry.is_sponsor_invited'
        db.delete_column('meetings_timetableentry', 'is_sponsor_invited')


    def backwards(self, orm):
        
        # Adding field 'TimetableEntry.is_sponsor_invited'
        db.add_column('meetings_timetableentry', 'is_sponsor_invited', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
