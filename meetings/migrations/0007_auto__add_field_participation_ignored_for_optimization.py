...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.ignored_for_optimization'
        db.add_column('meetings_participation', 'ignored_for_optimization', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Participation.ignored_for_optimization'
        db.delete_column('meetings_participation', 'ignored_for_optimization')
