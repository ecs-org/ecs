...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.expedited_reviewer_invitation_sent_for'
        db.add_column('meetings_meeting', 'expedited_reviewer_invitation_sent_for', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.expedited_reviewer_invitation_sent_for'
        db.delete_column('meetings_meeting', 'expedited_reviewer_invitation_sent_for')
