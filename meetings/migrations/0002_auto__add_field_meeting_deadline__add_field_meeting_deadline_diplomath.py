...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.deadline'
        db.add_column('meetings_meeting', 'deadline', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Meeting.deadline_diplomathesis'
        db.add_column('meetings_meeting', 'deadline_diplomathesis', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.deadline'
        db.delete_column('meetings_meeting', 'deadline')

        # Deleting field 'Meeting.deadline_diplomathesis'
        db.delete_column('meetings_meeting', 'deadline_diplomathesis')
