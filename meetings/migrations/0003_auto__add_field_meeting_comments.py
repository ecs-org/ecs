...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.comments'
        db.add_column('meetings_meeting', 'comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.comments'
        db.delete_column('meetings_meeting', 'comments')
