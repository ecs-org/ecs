...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.expedited_reviewer_invitation_sent_at'
        db.add_column('meetings_meeting', 'expedited_reviewer_invitation_sent_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Meeting.expedited_reviewer_invitation_sent_at'
        db.delete_column('meetings_meeting', 'expedited_reviewer_invitation_sent_at')
