...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimetableEntry.timetable_index'
        db.alter_column('meetings_timetableentry', 'timetable_index', self.gf('django.db.models.fields.IntegerField')(null=True))
        ...
        # Removing M2M table for field expedited_submissions on 'Meeting'
        db.delete_table('meetings_meeting_expedited_submissions')


    def backwards(self, orm):
        
        # Changing field 'TimetableEntry.timetable_index'
        db.alter_column('meetings_timetableentry', 'timetable_index', self.gf('django.db.models.fields.IntegerField')())
        ...
        # Adding M2M table for field expedited_submissions on 'Meeting'
        db.create_table('meetings_meeting_expedited_submissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meeting', models.ForeignKey(orm['meetings.meeting'], null=False)),
            ('submission', models.ForeignKey(orm['core.submission'], null=False))
        ))
        db.create_unique('meetings_meeting_expedited_submissions', ['meeting_id', 'submission_id'])
