...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.changed_after_voting'
        db.add_column('votes_vote', 'changed_after_voting', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.changed_after_voting'
        db.delete_column('votes_vote', 'changed_after_voting')
