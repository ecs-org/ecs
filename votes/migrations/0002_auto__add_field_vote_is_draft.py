...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.is_draft'
        db.add_column('votes_vote', 'is_draft', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.is_draft'
        db.delete_column('votes_vote', 'is_draft')
