...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.upgrade_for'
        db.add_column('votes_vote', 'upgrade_for', self.gf('django.db.models.fields.related.OneToOneField')(related_name='previous', unique=True, null=True, to=orm['votes.Vote']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.upgrade_for'
        db.delete_column('votes_vote', 'upgrade_for_id')
