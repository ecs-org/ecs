...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ScratchPad', fields ['owner', 'submission']
        db.create_unique('scratchpad_scratchpad', ['owner_id', 'submission_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScratchPad', fields ['owner', 'submission']
        db.delete_unique('scratchpad_scratchpad', ['owner_id', 'submission_id'])
    ...
    models = {
        ...
        'scratchpad.scratchpad': {
            'Meta': {'unique_together': "(('owner', 'submission'),)", 'object_name': 'ScratchPad'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
