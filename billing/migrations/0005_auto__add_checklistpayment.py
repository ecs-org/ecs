...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ChecklistPayment'
        db.create_table('billing_checklistpayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('document', self.gf('django.db.models.fields.related.OneToOneField')(related_name='checklist_payment', unique=True, null=True, to=orm['documents.Document'])),
        ))
        db.send_create_signal('billing', ['ChecklistPayment'])

        # Adding M2M table for field checklists on 'ChecklistPayment'
        db.create_table('billing_checklistpayment_checklists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('checklistpayment', models.ForeignKey(orm['billing.checklistpayment'], null=False)),
            ('checklist', models.ForeignKey(orm['checklists.checklist'], null=False))
        ))
        db.create_unique('billing_checklistpayment_checklists', ['checklistpayment_id', 'checklist_id'])


    def backwards(self, orm):
        
        # Deleting model 'ChecklistPayment'
        db.delete_table('billing_checklistpayment')

        # Removing M2M table for field checklists on 'ChecklistPayment'
        db.delete_table('billing_checklistpayment_checklists')
    ...
    models = {
        ...
        'billing.checklistbillingstate': {
            'Meta': {'object_name': 'ChecklistBillingState'},
            'billed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            'checklist': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'billing_state'", 'unique': 'True', 'null': 'True', 'to': "orm['checklists.Checklist']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'billing.checklistpayment': {
            'Meta': {'object_name': 'ChecklistPayment'},
            'checklists': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['checklists.Checklist']", 'symmetrical': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'checklist_payment'", 'unique': 'True', 'null': 'True', 'to': "orm['documents.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'billing.invoice': {
            'Meta': {'object_name': 'Invoice'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'document': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'invoice'", 'unique': 'True', 'null': 'True', 'to': "orm['documents.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
