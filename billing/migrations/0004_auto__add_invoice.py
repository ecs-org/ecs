...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('billing_invoice', (
            ...
            ('document', self.gf('django.db.models.fields.related.OneToOneField')(related_name='invoice', unique=True, null=True, to=orm['documents.Document'])),
        ))
        db.send_create_signal('billing', ['Invoice'])

        # Adding M2M table for field submissions on 'Invoice'
        db.create_table('billing_invoice_submissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('invoice', models.ForeignKey(orm['billing.invoice'], null=False)),
            ('submission', models.ForeignKey(orm['core.submission'], null=False))
        ))
        db.create_unique('billing_invoice_submissions', ['invoice_id', 'submission_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field submissions on 'Invoice'
        db.delete_table('billing_invoice_submissions')
