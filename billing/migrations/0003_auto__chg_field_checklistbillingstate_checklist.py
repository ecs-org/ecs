...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChecklistBillingState.checklist'
        db.alter_column('billing_checklistbillingstate', 'checklist_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['checklists.Checklist']))


    def backwards(self, orm):
        
        # Changing field 'ChecklistBillingState.checklist'
        db.alter_column('billing_checklistbillingstate', 'checklist_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['core.Checklist']))
