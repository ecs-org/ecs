...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Price.text'
        db.delete_column('billing_price', 'text')


    def backwards(self, orm):
        
        # We cannot add back in field 'Price.text'
        raise RuntimeError(
            "Cannot reverse this migration. 'Price.text' and its values cannot be restored.")
