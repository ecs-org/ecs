...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Thread.timestamp'
        db.alter_column('communication_thread', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Message.timestamp'
        db.alter_column('communication_message', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Thread.timestamp'
        db.alter_column('communication_thread', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Message.timestamp'
        db.alter_column('communication_message', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'communication.message': {
            ...
            'rawmsg': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'rawmsg_digest_hex': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'db_index': 'True'}),
            'rawmsg_msgid': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'db_index': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'incoming_messages'", 'to': "orm['auth.User']"}),
            'reply_receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reply_receiver_for_messages'", 'null': 'True', 'to': "orm['auth.User']"}),
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'replies'", 'null': 'True', 'to': "orm['communication.Message']"}),
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['communication.Thread']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'unread': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'619bbe90b45a4c5c880b7076cfee3678'", 'max_length': '32', 'db_index': 'True'})
        },
        'communication.thread': {
            'Meta': {'object_name': 'Thread'},
            'closed_by_receiver': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'closed_by_sender': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_message': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'head'", 'unique': 'True', 'null': 'True', 'to': "orm['communication.Message']"}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'incoming_threads'", 'to': "orm['auth.User']"}),
            'related_thread': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['communication.Thread']", 'null': 'True'}),
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'1ae1d3f5b1064d03bdf4b226e3ce041e'", 'unique': 'True', 'max_length': '36'}),
