...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.soft_bounced'
        db.add_column('communication_message', 'soft_bounced', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.soft_bounced'
        db.delete_column('communication_message', 'soft_bounced')
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'d4713ab8059241ecba7db2b8debf5d78'", 'max_length': '32', 'db_index': 'True'})
        },
