...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.reply_receiver'
        db.add_column('communication_message', 'reply_receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reply_receiver_for_messages', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.reply_receiver'
        db.delete_column('communication_message', 'reply_receiver_id')
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'872a3eca12444380afaffca3ffd0dcf8'", 'max_length': '32', 'db_index': 'True'})
        },
