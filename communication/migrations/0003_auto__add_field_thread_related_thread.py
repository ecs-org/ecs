...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.related_thread'
        db.add_column('communication_thread', 'related_thread', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['communication.Thread'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Thread.related_thread'
        db.delete_column('communication_thread', 'related_thread_id')
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'af406d0bd5ef496f83308f7ec96474b5'", 'max_length': '32', 'db_index': 'True'})
        },
