...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.rawmsg'
        db.add_column('communication_message', 'rawmsg', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'Message.rawmsg_msgid'
        db.add_column('communication_message', 'rawmsg_msgid', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, db_index=True), keep_default=False)

        # Adding field 'Message.rawmsg_digest_hex'
        db.add_column('communication_message', 'rawmsg_digest_hex', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.rawmsg'
        db.delete_column('communication_message', 'rawmsg')

        # Deleting field 'Message.rawmsg_msgid'
        db.delete_column('communication_message', 'rawmsg_msgid')

        # Deleting field 'Message.rawmsg_digest_hex'
        db.delete_column('communication_message', 'rawmsg_digest_hex')
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c917ebd688a74865a044246af632f2ea'", 'max_length': '32', 'db_index': 'True'})
        },
