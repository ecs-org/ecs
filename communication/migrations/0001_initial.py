...
class Migration(SchemaMigration):
    depends_on = (
        ('core', '0041_auto__add_field_submission_next_meeting'),
    )
    ...
    def forwards(self, orm):
        ...
        db.create_table('communication_message', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='23b133542e3744ac9876c3c72a62ad1d', max_length=32, db_index=True)),
        ))
    ...
    models = {
        ...
        'communication.message': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'09ffb229544044fcb8eebf580632636b'", 'max_length': '32', 'db_index': 'True'})
        },
