...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.pdfviewer_settings'
        db.add_column('users_usersettings', 'pdfviewer_settings', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSettings.pdfviewer_settings'
        db.delete_column('users_usersettings', 'pdfviewer_settings')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15bd06c3e3b942dbaa6b05ea66d51209'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
