...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # We cannot add back in field 'UserSettings.task_filter'
        raise RuntimeError(
            "Cannot reverse this migration. 'UserSettings.task_filter' and its values cannot be restored.")
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'eda81cf93b194e15880abab38ab24e29'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
