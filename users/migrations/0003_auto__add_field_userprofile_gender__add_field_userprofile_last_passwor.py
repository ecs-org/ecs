...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('users_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default='m', max_length=1), keep_default=False)

        # Adding field 'UserProfile.last_password_change'
        db.add_column('users_userprofile', 'last_password_change', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.gender'
        db.delete_column('users_userprofile', 'gender')

        # Deleting field 'UserProfile.last_password_change'
        db.delete_column('users_userprofile', 'last_password_change')
