...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for group in groups:
            users = orm['auth.User'].objects.filter(groups=group)
            for user in users:
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3a17031197114f269a8a860575fa73ab'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
