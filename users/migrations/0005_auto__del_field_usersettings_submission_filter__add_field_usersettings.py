...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.submission_filter_all'
        db.add_column('users_usersettings', 'submission_filter_all', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)

        # Adding field 'UserSettings.submission_filter_widget'
        db.add_column('users_usersettings', 'submission_filter_widget', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)

        # Adding field 'UserSettings.submission_filter_widget_internal'
        db.add_column('users_usersettings', 'submission_filter_widget_internal', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)

        # Adding field 'UserSettings.submission_filter_mine'
        db.add_column('users_usersettings', 'submission_filter_mine', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)

        # Adding field 'UserSettings.submission_filter_assigned'
        db.add_column('users_usersettings', 'submission_filter_assigned', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserSettings.submission_filter_all'
        db.delete_column('users_usersettings', 'submission_filter_all')

        # Deleting field 'UserSettings.submission_filter_widget'
        db.delete_column('users_usersettings', 'submission_filter_widget')

        # Deleting field 'UserSettings.submission_filter_widget_internal'
        db.delete_column('users_usersettings', 'submission_filter_widget_internal')

        # Deleting field 'UserSettings.submission_filter_mine'
        db.delete_column('users_usersettings', 'submission_filter_mine')

        # Deleting field 'UserSettings.submission_filter_assigned'
        db.delete_column('users_usersettings', 'submission_filter_assigned')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2209c51ade134b45a5063a4e222642c4'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
