...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.help_writer'
        db.add_column('users_userprofile', 'help_writer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.help_writer'
        db.delete_column('users_userprofile', 'help_writer')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'001be74d1af4497bb45af0b1c1db6d8d'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
