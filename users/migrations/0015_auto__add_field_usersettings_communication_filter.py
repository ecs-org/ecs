...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.communication_filter'
        db.add_column('users_usersettings', 'communication_filter', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSettings.communication_filter'
        db.delete_column('users_usersettings', 'communication_filter')
