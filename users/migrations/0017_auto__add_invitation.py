...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_invitation', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(default='5687189aa52548a595e9991c8b9047c1', unique=True, max_length=32)),
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'35f79014724e4d15b648945c541bd0fe'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
