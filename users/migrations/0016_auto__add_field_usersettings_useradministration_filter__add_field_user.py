...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserSettings.useradministration_filter'
        db.add_column('users_usersettings', 'useradministration_filter', self.gf('django_extensions.db.fields.json.JSONField')(), keep_default=False)

        # Adding field 'UserProfile.phantom'
        db.add_column('users_userprofile', 'phantom', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserSettings.useradministration_filter'
        db.delete_column('users_usersettings', 'useradministration_filter')

        # Deleting field 'UserProfile.phantom'
        db.delete_column('users_userprofile', 'phantom')
