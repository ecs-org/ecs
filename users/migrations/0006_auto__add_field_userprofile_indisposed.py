...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.indisposed'
        db.add_column('users_userprofile', 'indisposed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.indisposed'
        db.delete_column('users_userprofile', 'indisposed')
