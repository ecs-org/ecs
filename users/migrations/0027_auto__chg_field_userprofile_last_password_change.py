...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.last_password_change'
        db.alter_column('users_userprofile', 'last_password_change', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.last_password_change'
        db.alter_column('users_userprofile', 'last_password_change', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b5fc7647b6324531b73da8de077fcd0b'", 'unique': 'True', 'max_length': '32'})
        },
        'users.loginhistory': {
        ...
        'users.userprofile': {
            ...
            'last_password_change': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
