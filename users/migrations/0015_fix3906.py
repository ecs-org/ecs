...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for profile in orm.UserProfile.objects.filter(forward_messages_after_minutes=0, is_testuser=False):
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f033ff705d584c4cbd939a373b2cca01'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
