...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.approved_by_office'
        db.add_column('users_userprofile', 'approved_by_office', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.approved_by_office'
        db.delete_column('users_userprofile', 'approved_by_office')
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'approved_by_office': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
