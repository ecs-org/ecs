...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.communication_proxy'
        db.add_column('users_userprofile', 'communication_proxy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.communication_proxy'
        db.delete_column('users_userprofile', 'communication_proxy_id')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'706840e8ce1e4c908e8692588523545a'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_approved_by_office': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
