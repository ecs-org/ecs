...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.forward_messages_after_minutes'
        db.add_column('users_userprofile', 'forward_messages_after_minutes', self.gf('django.db.models.fields.PositiveIntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.forward_messages_after_minutes'
        db.delete_column('users_userprofile', 'forward_messages_after_minutes')
    ...
    models = {
        ...
        'users.invitation': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'481a6b3a32944d74b812af05096f3d76'", 'unique': 'True', 'max_length': '32'})
        },
        'users.userprofile': {
            ...
            'forward_messages_after_minutes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5'}),
