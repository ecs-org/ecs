...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pdfviewer_documentannotation', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='document_annotations', to=orm['auth.User'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='annotations', to=orm['documents.Document'])),
    ...
    models = {
        ...
        'pdfviewer.documentannotation': {
            ...
            'document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'annotations'", 'to': "orm['documents.Document']"}),
            'height': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_number': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'document_annotations'", 'to': "orm['auth.User']"}),
