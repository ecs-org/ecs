...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Certificate', fields ['serial']
        db.create_unique('pki_certificate', ['serial'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Certificate', fields ['serial']
        db.delete_unique('pki_certificate', ['serial'])
    ...
    models = {
        ...
        'pki.certificate': {
            ...
            'serial': ('django.db.models.fields.IntegerField', [], {'default': '4', 'unique': 'True'}),
