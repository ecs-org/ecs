...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pki_certificate', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='certificates', to=orm['auth.User'])),
            ('subject', self.gf('django.db.models.fields.TextField')()),
            ('fingerprint', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('is_revoked', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
