...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Certificate.fingerprint'
        db.delete_column('pki_certificate', 'fingerprint')


    def backwards(self, orm):
        
        # We cannot add back in field 'Certificate.fingerprint'
        raise RuntimeError(
            "Cannot reverse this migration. 'Certificate.fingerprint' and its values cannot be restored.")
