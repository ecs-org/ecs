...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('documents_document', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Changing field 'Document.file'
        db.alter_column('documents_document', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
