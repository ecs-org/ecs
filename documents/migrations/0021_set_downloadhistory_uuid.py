...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('''
            update documents_downloadhistory hist set uuid = doc.uuid
    ...
    models = {
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'29799152e75c435daebbc989a36e3957'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
        ...
        'documents.downloadhistory': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'f68293ceb50041a78145aee090b417b8'", 'max_length': '36', 'db_index': 'True'})
        }
    }
