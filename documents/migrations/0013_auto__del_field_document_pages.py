...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('documents_document', 'pages')


    def backwards(self, orm):
        
        # Adding field 'Document.pages'
        db.add_column('documents_document', 'pages', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'60522c7800924726a2f3c4d7e831e944'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
