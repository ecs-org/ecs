...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.replaces_document'
        db.add_column('documents_document', 'replaces_document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.replaces_document'
        db.delete_column('documents_document', 'replaces_document_id')
    ...
    models = {
        ...
        'documents.document': {
            ...
            'replaces_document': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['documents.Document']", 'null': 'True'}),
