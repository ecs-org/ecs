...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('documents_document', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Document.object_id'
        db.add_column('documents_document', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.content_type'
        db.delete_column('documents_document', 'content_type_id')

        # Deleting field 'Document.object_id'
        db.delete_column('documents_document', 'object_id')
