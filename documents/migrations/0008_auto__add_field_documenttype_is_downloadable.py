...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentType.is_downloadable'
        db.add_column('documents_documenttype', 'is_downloadable', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentType.is_downloadable'
        db.delete_column('documents_documenttype', 'is_downloadable')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'25dc7cda8ead4c3790b37288b8494888'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
