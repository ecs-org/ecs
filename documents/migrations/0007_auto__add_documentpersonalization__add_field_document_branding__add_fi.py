...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('documents_documentpersonalization', (
            ('id', self.gf('django.db.models.fields.SlugField')(default='2d14f0631fb742a587a0c3f0e2dda07a', max_length=36, primary_key=True, db_index=True)),
        ...
        # Adding field 'Document.branding'
        db.add_column('documents_document', 'branding', self.gf('django.db.models.fields.CharField')(default='b', max_length=1), keep_default=False)

        # Adding field 'Document.allow_download'
        db.add_column('documents_document', 'allow_download', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Document.branding'
        db.delete_column('documents_document', 'branding')

        # Deleting field 'Document.allow_download'
        db.delete_column('documents_document', 'allow_download')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'2d14f0631fb742a587a0c3f0e2dda07a'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
