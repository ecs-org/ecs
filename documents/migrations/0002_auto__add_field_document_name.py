...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('documents_document', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=250), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.name'
        db.delete_column('documents_document', 'name')
    ...
    models = {
        ...
        'documents.documentpersonalization': {
            ...
            'id': ('django.db.models.fields.SlugField', [], {'default': "'a873c36ba6af4959bc616859814afe4f'", 'max_length': '36', 'primary_key': 'True', 'db_index': 'True'}),
