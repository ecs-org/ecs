...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('''
            update documents_document set stamp_on_download = (branding in ('b', 'p'))
        ''')
    ...
    models = {
        ...
        'documents.document': {
            ...
            'uuid': ('django.db.models.fields.SlugField', [], {'default': "'deae88f32cbe477e82d6597da1bb534c'", 'unique': 'True', 'max_length': '36', 'db_index': 'True'}),
