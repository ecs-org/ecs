...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Document', fields ['uuid_document']
        db.create_unique('documents_document', ['uuid_document'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Document', fields ['uuid_document']
        db.delete_unique('documents_document', ['uuid_document'])
