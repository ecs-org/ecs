from ecs.core.views.submissions import (create_submission_form, copy_submission_form, submission_pdf,
    ...
    vote_review, b2_vote_review, export_submission, import_submission_form, befangene_review, diff, wizard, submission_widget,
    submission_list, upload_document_for_submission,
