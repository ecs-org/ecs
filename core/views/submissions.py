...
def submission_form_list(request):
    ...
    if keyword:
        ...
        form_search_query = Q(project_title__icontains=keyword) | Q(german_project_title__icontains=keyword) | Q(sponsor_name__icontains=keyword) | Q(submitter_contact_last_name__icontains=keyword) | Q(investigators__name__icontains=keyword)
