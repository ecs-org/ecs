...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Investigator.name'
        db.delete_column('core_investigator', 'name')

        # Deleting field 'SubmissionForm.sponsor_contactname'
        db.delete_column('core_submissionform', 'sponsor_contactname')

        # Deleting field 'SubmissionForm.submitter_name'
        db.delete_column('core_submissionform', 'submitter_name')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Investigator.name'
        db.add_column('core_investigator', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Adding field 'SubmissionForm.sponsor_contactname'
        db.add_column('core_submissionform', 'sponsor_contactname', self.gf('django.db.models.fields.CharField')(max_length=80, null=True), keep_default=False)

        # Adding field 'SubmissionForm.submitter_name'
        db.add_column('core_submissionform', 'submitter_name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Adding field 'SubmissionForm.invoice_contactname'
        db.add_column('core_submissionform', 'invoice_contactname', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True), keep_default=False)
