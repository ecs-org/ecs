...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_submission', 'ec_number', self.gf('django.db.models.fields.CharField')(blank=True, unique=True, max_length=50, null=True, db_index=True), keep_default=False)
