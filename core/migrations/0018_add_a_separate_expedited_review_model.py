...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MedicalCategory.expedited_review'
        db.delete_column('core_medicalcategory', 'expedited_review')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'MedicalCategory.expedited_review'
        db.add_column('core_medicalcategory', 'expedited_review', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'core.submission': {
            ...
            'expedited_review_categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'submissions'", 'to': "orm['core.ExpeditedReviewCategory']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medical_categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'submissions'", 'to': "orm['core.MedicalCategory']"}),
