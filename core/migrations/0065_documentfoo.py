...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        sf_ctype = ContentType.objects.get_for_model(orm.SubmissionForm)
        for sf in orm.SubmissionForm.objects.all():
            docs = orm['documents.Document'].objects.filter(content_type__id=sf_ctype.id, object_id=sf.id)
            sf.documents = docs
            sf.save()
