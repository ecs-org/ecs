...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.pdf_document'
        db.add_column('core_checklist', 'pdf_document', self.gf('django.db.models.fields.related.OneToOneField')(related_name='checklist', unique=True, null=True, to=orm['documents.Document']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Checklist.pdf_document'
        db.delete_column('core_checklist', 'pdf_document_id')
