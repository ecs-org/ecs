...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('drop table if exists pdfviewer_documentannotation')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 24, 10, 37, 30, 293376)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
