...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Investigator.contact_title'
        db.add_column('core_investigator', 'contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.submitter_contact_title'
        db.add_column('core_submissionform', 'submitter_contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.invoice_contact_title'
        db.add_column('core_submissionform', 'invoice_contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.sponsor_contact_title'
        db.add_column('core_submissionform', 'sponsor_contact_title', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Investigator.contact_title'
        db.delete_column('core_investigator', 'contact_title')

        # Deleting field 'SubmissionForm.submitter_contact_title'
        db.delete_column('core_submissionform', 'submitter_contact_title')

        # Deleting field 'SubmissionForm.invoice_contact_title'
        db.delete_column('core_submissionform', 'invoice_contact_title')

        # Deleting field 'SubmissionForm.sponsor_contact_title'
        db.delete_column('core_submissionform', 'sponsor_contact_title')
    ...
    models = {
        ...
        'core.submission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'insurance_review_required': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
