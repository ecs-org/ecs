...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'ChecklistQuestion', fields ['index']
        db.create_index('core_checklistquestion', ['index'])

        # Adding index on 'ChecklistQuestion', fields ['number']
        db.create_index('core_checklistquestion', ['number'])


    def backwards(self, orm):
        
        # Removing index on 'ChecklistQuestion', fields ['number']
        db.delete_index('core_checklistquestion', ['number'])

        # Removing index on 'ChecklistQuestion', fields ['index']
        db.delete_index('core_checklistquestion', ['index'])
