...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.start'
        db.add_column('core_meeting', 'start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 4, 8, 20, 8, 49, 503276)), keep_default=False)

        # Adding field 'Meeting.title'
        db.add_column('core_meeting', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_meeting', 'start')

        # Deleting field 'Meeting.title'
        db.delete_column('core_meeting', 'title')
    ...
    models = {
        ...
        'core.timetableentry': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "'Participation'"})
        },
        'core.vote': {
