...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.presenter'
        db.add_column('core_submission', 'presenter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='presented_submissions', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Submission.susar_presenter'
        db.add_column('core_submission', 'susar_presenter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='susar_presented_submissions', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.presenter'
        db.delete_column('core_submission', 'presenter_id')

        # Deleting field 'Submission.susar_presenter'
        db.delete_column('core_submission', 'susar_presenter_id')
    ...
    models = {
        ...
        'core.submission': {
            ...
            'presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'presented_submissions'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'susar_presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'susar_presented_submissions'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 16, 24, 5, 966445)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
