...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.multiple'
        db.add_column('core_checklistblueprint', 'multiple', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.multiple'
        db.delete_column('core_checklistblueprint', 'multiple')
