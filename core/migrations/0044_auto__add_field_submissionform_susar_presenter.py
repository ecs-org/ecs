...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.susar_presenter'
        db.add_column('core_submissionform', 'susar_presenter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='susar_presented_submission_forms', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.susar_presenter'
        db.delete_column('core_submissionform', 'susar_presenter_id')
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'susar_presenter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'susar_presented_submission_forms'", 'null': 'True', 'to': "orm['auth.User']"}),
            'transient': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'core.vote': {
