...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocumentType.identifier'
        db.add_column('core_documenttype', 'identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=30, db_index=True, blank=True), keep_default=False)

        # Adding field 'DocumentType.helptext'
        db.add_column('core_documenttype', 'helptext', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DocumentType.identifier'
        db.delete_column('core_documenttype', 'identifier')

        # Deleting field 'DocumentType.helptext'
        db.delete_column('core_documenttype', 'helptext')
