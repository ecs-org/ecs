...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.submission'
        db.add_column('core_checklist', 'submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='checklists', null=True, to=orm['core.Submission']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Checklist.submission'
        db.delete_column('core_checklist', 'submission_id')
