...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.retrospective'
        db.add_column('core_submission', 'retrospective', self.gf('django.db.models.fields.NullBooleanField')(null=True), keep_default=False)

        # Adding field 'Submission.expedited'
        db.add_column('core_submission', 'expedited', self.gf('django.db.models.fields.NullBooleanField')(null=True), keep_default=False)

        # Adding field 'Submission.thesis'
        db.add_column('core_submission', 'thesis', self.gf('django.db.models.fields.NullBooleanField')(null=True), keep_default=False)

        # Adding field 'Submission.external_reviewer'
        db.add_column('core_submission', 'external_reviewer', self.gf('django.db.models.fields.NullBooleanField')(null=True), keep_default=False)

        # Adding field 'Submission.external_reviewer_name'
        db.add_column('core_submission', 'external_reviewer_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Deleting field 'SubmissionForm.thesis'
        db.delete_column('core_submissionform', 'thesis')

        # Deleting field 'SubmissionForm.external_reviewer'
        db.delete_column('core_submissionform', 'external_reviewer')

        # Deleting field 'SubmissionForm.external_reviewer_name'
        db.delete_column('core_submissionform', 'external_reviewer_name_id')

        # Deleting field 'SubmissionForm.expedited'
        db.delete_column('core_submissionform', 'expedited')

        # Deleting field 'SubmissionForm.retrospective'
        db.delete_column('core_submissionform', 'retrospective')
    
    
    def backwards(self, orm):
        
        # Deleting field 'Submission.retrospective'
        db.delete_column('core_submission', 'retrospective')

        # Deleting field 'Submission.expedited'
        db.delete_column('core_submission', 'expedited')

        # Deleting field 'Submission.thesis'
        db.delete_column('core_submission', 'thesis')
        ...
        # Adding field 'SubmissionForm.thesis'
        db.add_column('core_submissionform', 'thesis', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.external_reviewer'
        db.add_column('core_submissionform', 'external_reviewer', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.external_reviewer_name'
        db.add_column('core_submissionform', 'external_reviewer_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Adding field 'SubmissionForm.expedited'
        db.add_column('core_submissionform', 'expedited', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.retrospective'
        db.add_column('core_submissionform', 'retrospective', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'core.medicalcategory': {
            ...
            'expeditedreview': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
        ...
        'core.submission': {
            ...
            'external_reviewer_name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medical_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.MedicalCategory']"}),
