...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.submitter_contact_gender'
        db.add_column('core_submissionform', 'submitter_contact_gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.submitter_contact_first_name'
        db.add_column('core_submissionform', 'submitter_contact_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.submitter_contact_last_name'
        db.add_column('core_submissionform', 'submitter_contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.submitter_contact_gender'
        db.delete_column('core_submissionform', 'submitter_contact_gender')

        # Deleting field 'SubmissionForm.submitter_contact_first_name'
        db.delete_column('core_submissionform', 'submitter_contact_first_name')

        # Deleting field 'SubmissionForm.submitter_contact_last_name'
        db.delete_column('core_submissionform', 'submitter_contact_last_name')
