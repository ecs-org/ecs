...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_document', 'deleted', orm['core.document:deleted'])
        
        # Deleting field 'Document.absent'
        db.delete_column('core_document', 'absent')
        
    
    def backwards(self, orm):
        
        # Deleting field 'Document.deleted'
        db.delete_column('core_document', 'deleted')
        
        # Adding field 'Document.absent'
        db.add_column('core_document', 'absent', orm['core.document:absent'])
