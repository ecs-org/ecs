...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionForm.submitter_sign_date'
        db.delete_column('core_submissionform', 'submitter_sign_date')
        
        # Changing field 'Measure.count'
        # (to signature: django.db.models.fields.TextField())
        db.alter_column('core_measure', 'count', orm['core.measure:count'])
        
        # Changing field 'SubmissionForm.project_title'
        # (to signature: django.db.models.fields.TextField())
        db.alter_column('core_submissionform', 'project_title', orm['core.submissionform:project_title'])
        
    
    
    def backwards(self, orm):
        
        # Adding field 'SubmissionForm.submitter_sign_date'
        db.add_column('core_submissionform', 'submitter_sign_date', orm['core.submissionform:submitter_sign_date'])
