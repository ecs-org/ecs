...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.susar_presenter'
        db.alter_column('core_submissionform', 'susar_presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.susar_presenter'
        db.alter_column('core_submissionform', 'susar_presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
