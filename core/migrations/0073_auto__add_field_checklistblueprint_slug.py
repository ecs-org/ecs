...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.slug'
        db.add_column('core_checklistblueprint', 'slug', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.slug'
        db.delete_column('core_checklistblueprint', 'slug')
