...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.gcp_review_required'
        db.add_column('core_submission', 'gcp_review_required', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.gcp_review_required'
        db.delete_column('core_submission', 'gcp_review_required')
