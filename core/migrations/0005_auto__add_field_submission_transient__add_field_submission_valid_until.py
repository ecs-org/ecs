...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.transient'
        db.add_column('core_submission', 'transient', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Submission.valid_until'
        db.add_column('core_submission', 'valid_until', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.transient'
        db.delete_column('core_submission', 'transient')

        # Deleting field 'Submission.valid_until'
        db.delete_column('core_submission', 'valid_until')
