...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.study_plan_8_1_15'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_15', orm['core.submissionform:study_plan_8_1_15'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_22'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_22', orm['core.submissionform:study_plan_8_1_22'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_20'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_20', orm['core.submissionform:study_plan_8_1_20'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_21'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_21', orm['core.submissionform:study_plan_8_1_21'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_19'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_19', orm['core.submissionform:study_plan_8_1_19'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_18'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_18', orm['core.submissionform:study_plan_8_1_18'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_17'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_17', orm['core.submissionform:study_plan_8_1_17'])
        
        # Changing field 'SubmissionForm.study_plan_8_1_16'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_8_1_16', orm['core.submissionform:study_plan_8_1_16'])
