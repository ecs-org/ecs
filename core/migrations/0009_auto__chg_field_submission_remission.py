...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.remission'
        db.alter_column('core_submission', 'remission', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Submission.remission'
        db.alter_column('core_submission', 'remission', self.gf('django.db.models.fields.BooleanField')())
