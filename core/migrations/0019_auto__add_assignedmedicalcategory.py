...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_assignedmedicalcategory', (
        ...
        db.send_create_signal('core', ['AssignedMedicalCategory'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('core_assignedmedicalcategory')
    ...
    models = {
        ...
        'core.assignedmedicalcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Meeting']"})
        },
        'core.checklist': {
        ...
        'core.submission': {
            ...
            'study_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'submissions'", 'null': 'True', 'to': "orm['core.StudyType']"}),
