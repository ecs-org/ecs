...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participation.entry'
        db.alter_column('core_participation', 'entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.TimetableEntry']))
