...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.presenter'
        db.add_column('core_submissionform', 'presenter', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='presented_submission_forms', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.presenter'
        db.delete_column('core_submissionform', 'presenter_id')
