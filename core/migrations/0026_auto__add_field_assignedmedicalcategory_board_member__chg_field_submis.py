...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssignedMedicalCategory.board_member'
        db.add_column('core_assignedmedicalcategory', 'board_member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Removing M2M table for field board_members on 'AssignedMedicalCategory'
        db.delete_table('core_assignedmedicalcategory_board_members')

        # Changing field 'SubmissionForm.sponsor_address2'
        db.alter_column('core_submissionform', 'sponsor_address2', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'AssignedMedicalCategory.board_member'
        db.delete_column('core_assignedmedicalcategory', 'board_member_id')

        # Adding M2M table for field board_members on 'AssignedMedicalCategory'
        db.create_table('core_assignedmedicalcategory_board_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assignedmedicalcategory', models.ForeignKey(orm['core.assignedmedicalcategory'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_assignedmedicalcategory_board_members', ['assignedmedicalcategory_id', 'user_id'])

        # Changing field 'SubmissionForm.sponsor_address2'
        db.alter_column('core_submissionform', 'sponsor_address2', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
