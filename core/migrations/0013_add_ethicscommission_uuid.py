...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EthicsCommission.uuid'
        db.add_column('core_ethicscommission', 'uuid', self.gf('django.db.models.fields.CharField')(default="", max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EthicsCommission.uuid'
        db.delete_column('core_ethicscommission', 'uuid')
