...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvolvedCommissionsForNotification.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.BaseNotificationForm']))
        db.alter_column('core_involvedcommissionsfornotification', 'submission_id', orm['core.involvedcommissionsfornotification:submission'])
        
        # Changing field 'ExtendedNotificationForm.basenotificationform_ptr'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['core.BaseNotificationForm'], unique=True, primary_key=True))
        db.alter_column('core_extendednotificationform', 'basenotificationform_ptr_id', orm['core.extendednotificationform:basenotificationform_ptr'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'InvolvedCommissionsForNotification.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.NotificationForm']))
        db.alter_column('core_involvedcommissionsfornotification', 'submission_id', orm['core.involvedcommissionsfornotification:submission'])
        
        # Changing field 'ExtendedNotificationForm.basenotificationform_ptr'
        # (to signature: django.db.models.fields.related.OneToOneField(to=orm['core.NotificationForm'], unique=True, primary_key=True))
        db.alter_column('core_extendednotificationform', 'basenotificationform_ptr_id', orm['core.extendednotificationform:basenotificationform_ptr'])
