...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Submission', fields ['ec_number']
        db.create_index('core_submission', ['ec_number'])

        # Adding unique constraint on 'Submission', fields ['ec_number']
        db.create_unique('core_submission', ['ec_number'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Submission', fields ['ec_number']
        db.delete_index('core_submission', ['ec_number'])

        # Removing unique constraint on 'Submission', fields ['ec_number']
        db.delete_unique('core_submission', ['ec_number'])
