...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.created_at'
        db.add_column('core_submissionform', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.created_at'
        db.delete_column('core_submissionform', 'created_at')
