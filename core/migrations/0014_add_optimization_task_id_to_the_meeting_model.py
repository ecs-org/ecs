...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Meeting.optimization_task_id'
        db.add_column('core_meeting', 'optimization_task_id', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Meeting.optimization_task_id'
        db.delete_column('core_meeting', 'optimization_task_id')
