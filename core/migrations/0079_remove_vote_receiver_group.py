...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            group = orm['auth.group'].objects.get(name='Vote Receiver Group')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 19, 14, 41, 50, 326812)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
