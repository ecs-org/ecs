...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.CharField(max_length=80, null=True))
        db.alter_column('core_submissionform', 'medtech_product_name', orm['core.submissionform:medtech_product_name'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_final_report'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_final_report', orm['core.submissionform:substance_p_c_t_final_report'])
        
        # Changing field 'SubmissionForm.substance_registered_in_countries'
        # (to signature: django.db.models.fields.CharField(max_length=300, null=True))
        db.alter_column('core_submissionform', 'substance_registered_in_countries', orm['core.submissionform:substance_registered_in_countries'])
        
        # Changing field 'SubmissionForm.medtech_ce_symbol'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'medtech_ce_symbol', orm['core.submissionform:medtech_ce_symbol'])
        
        # Changing field 'SubmissionForm.insurance_contract_number'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'insurance_contract_number', orm['core.submissionform:insurance_contract_number'])
        
        # Changing field 'SubmissionForm.medtech_reference_substance'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'medtech_reference_substance', orm['core.submissionform:medtech_reference_substance'])
        
        # Changing field 'SubmissionForm.insurance_phone'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'insurance_phone', orm['core.submissionform:insurance_phone'])
        
        # Changing field 'SubmissionForm.medtech_manufacturer'
        # (to signature: django.db.models.fields.CharField(max_length=80, null=True))
        db.alter_column('core_submissionform', 'medtech_manufacturer', orm['core.submissionform:medtech_manufacturer'])
        
        # Changing field 'SubmissionForm.specialism'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'specialism', orm['core.submissionform:specialism'])
        
        # Changing field 'SubmissionForm.substance_preexisting_clinical_tries'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'substance_preexisting_clinical_tries', orm['core.submissionform:substance_preexisting_clinical_tries'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_phase'
        # (to signature: django.db.models.fields.CharField(max_length=10, null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_phase', orm['core.submissionform:substance_p_c_t_phase'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_period'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_period', orm['core.submissionform:substance_p_c_t_period'])
        
        # Changing field 'SubmissionForm.insurance_address_1'
        # (to signature: django.db.models.fields.CharField(max_length=80, null=True))
        db.alter_column('core_submissionform', 'insurance_address_1', orm['core.submissionform:insurance_address_1'])
        
        # Changing field 'SubmissionForm.medtech_certified_for_exact_indications'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'medtech_certified_for_exact_indications', orm['core.submissionform:medtech_certified_for_exact_indications'])
        
        # Changing field 'SubmissionForm.medtech_manual_included'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'medtech_manual_included', orm['core.submissionform:medtech_manual_included'])
        
        # Changing field 'SubmissionForm.medtech_certified_for_other_indications'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'medtech_certified_for_other_indications', orm['core.submissionform:medtech_certified_for_other_indications'])
        
        # Changing field 'SubmissionForm.medtech_checked_product'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'medtech_checked_product', orm['core.submissionform:medtech_checked_product'])
        
        # Changing field 'SubmissionForm.insurance_validity'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'insurance_validity', orm['core.submissionform:insurance_validity'])
        
        # Changing field 'SubmissionForm.medtech_departure_from_regulations'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'medtech_departure_from_regulations', orm['core.submissionform:medtech_departure_from_regulations'])
        
        # Changing field 'SubmissionForm.medtech_technical_safety_regulations'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'medtech_technical_safety_regulations', orm['core.submissionform:medtech_technical_safety_regulations'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_countries'
        # (to signature: django.db.models.fields.CharField(max_length=300, null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_countries', orm['core.submissionform:substance_p_c_t_countries'])
        
        # Changing field 'SubmissionForm.insurance_name'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'insurance_name', orm['core.submissionform:insurance_name'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_gcp_rules'
        # (to signature: django.db.models.fields.NullBooleanField(null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_gcp_rules', orm['core.submissionform:substance_p_c_t_gcp_rules'])
        
        # Changing field 'SubmissionForm.substance_p_c_t_application_type'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'substance_p_c_t_application_type', orm['core.submissionform:substance_p_c_t_application_type'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubmissionForm.substance_registered_in_countries'
        # (to signature: django.db.models.fields.CharField(max_length=300))
        db.alter_column('core_submissionform', 'substance_registered_in_countries', orm['core.submissionform:substance_registered_in_countries'])
        ...
        # Changing field 'SubmissionForm.insurance_contract_number'
        # (to signature: django.db.models.fields.CharField(max_length=60))
        db.alter_column('core_submissionform', 'insurance_contract_number', orm['core.submissionform:insurance_contract_number'])
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'study_plan_8_1_15': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_16': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_17': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_18': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_19': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_2': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'study_plan_8_1_20': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_21': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            'study_plan_8_1_22': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '80'}),
            ...
            'substance_p_c_t_period': ('django.db.models.fields.CharField', [], {'max_length': '40', 'null': 'True'}),
