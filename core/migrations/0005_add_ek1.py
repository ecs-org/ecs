...
class Migration:
    ...
    def forwards(self, orm):
        ...
        ek = orm.EthicsCommission(
            name="Ethikkomission der Medizinischen Universität Wien",
            address_1="Borschkegasse 8b",
            address_2="",
            zip_code="1090",
            city="Wien")
        ek.save()
    ...
    def backwards(self, orm):
        ...
        for o in orm.EthicsCommission.objects.filter(name="Ethikkomission der Medizinischen Universität Wien"):
            o.delete()
