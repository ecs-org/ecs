...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.signed_at'
        db.add_column('core_vote', 'signed_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.signed_at'
        db.delete_column('core_vote', 'signed_at')
