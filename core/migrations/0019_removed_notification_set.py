...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notification.notificationset'
        db.delete_column('core_notification', 'notificationset_id')
        
        # Deleting model 'notificationset'
        db.delete_table('core_notificationset')
        
        # Changing field 'Notification.answer'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.NotificationAnswer'], null=True))
        db.alter_column('core_notification', 'answer_id', orm['core.notification:answer'])
        
        # Changing field 'Notification.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Submission'], null=True))
        db.alter_column('core_notification', 'submission_id', orm['core.notification:submission'])
        
        # Changing field 'Notification.workflow'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Workflow'], null=True))
        db.alter_column('core_notification', 'workflow_id', orm['core.notification:workflow'])
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Notification.notificationset'
        db.add_column('core_notification', 'notificationset', orm['core.notification:notificationset'])
        
        # Adding model 'notificationset'
        db.create_table('core_notificationset', (
            ('notification', orm['core.notification:notification']),
            ('documents', orm['core.notification:documents']),
            ('id', orm['core.notification:id']),
            ('notificationform', orm['core.notification:notificationform']),
        ))
        db.send_create_signal('core', ['notificationset'])
        
        # Changing field 'Notification.answer'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.NotificationAnswer']))
        db.alter_column('core_notification', 'answer_id', orm['core.notification:answer'])
        
        # Changing field 'Notification.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Submission']))
        db.alter_column('core_notification', 'submission_id', orm['core.notification:submission'])
        
        # Changing field 'Notification.workflow'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Workflow']))
        db.alter_column('core_notification', 'workflow_id', orm['core.notification:workflow'])
