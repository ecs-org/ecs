...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_extendednotificationform', (
            ('basenotificationform_ptr', orm['core.extendednotificationform:basenotificationform_ptr']),
            ('reason_for_not_started', orm['core.extendednotificationform:reason_for_not_started']),
            ('recruited_subjects', orm['core.extendednotificationform:recruited_subjects']),
            ('finished_subjects', orm['core.extendednotificationform:finished_subjects']),
            ('aborted_subjects', orm['core.extendednotificationform:aborted_subjects']),
            ('SAE_count', orm['core.extendednotificationform:SAE_count']),
            ('SUSAR_count', orm['core.extendednotificationform:SUSAR_count']),
            ('runs_till', orm['core.extendednotificationform:runs_till']),
            ('finished_on', orm['core.extendednotificationform:finished_on']),
            ('aborted_on', orm['core.extendednotificationform:aborted_on']),
            ('extension_of_vote', orm['core.extendednotificationform:extension_of_vote']),
        ))
    ...
    models = {
        ...
        'core.extendednotificationform': {
            ...
            'basenotificationform_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.NotificationForm']", 'unique': 'True', 'primary_key': 'True'}),
