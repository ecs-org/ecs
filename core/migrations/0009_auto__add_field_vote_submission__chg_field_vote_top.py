...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Vote.submission'
        db.delete_column('core_vote', 'submission_id')

        # Changing field 'Vote.top'
        db.alter_column('core_vote', 'top_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['core.TimetableEntry']))
