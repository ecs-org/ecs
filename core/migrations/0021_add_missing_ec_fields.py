...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EthicsCommission.contactname'
        db.add_column('core_ethicscommission', 'contactname', orm['core.ethicscommission:contactname'])
        
        # Adding field 'EthicsCommission.email'
        db.add_column('core_ethicscommission', 'email', orm['core.ethicscommission:email'])
        
        # Adding field 'EthicsCommission.url'
        db.add_column('core_ethicscommission', 'url', orm['core.ethicscommission:url'])
        
        # Adding field 'EthicsCommission.fax'
        db.add_column('core_ethicscommission', 'fax', orm['core.ethicscommission:fax'])
        
        # Adding field 'EthicsCommission.chairperson'
        db.add_column('core_ethicscommission', 'chairperson', orm['core.ethicscommission:chairperson'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EthicsCommission.contactname'
        db.delete_column('core_ethicscommission', 'contactname')
        
        # Deleting field 'EthicsCommission.email'
        db.delete_column('core_ethicscommission', 'email')
        
        # Deleting field 'EthicsCommission.url'
        db.delete_column('core_ethicscommission', 'url')
        
        # Deleting field 'EthicsCommission.fax'
        db.delete_column('core_ethicscommission', 'fax')
        
        # Deleting field 'EthicsCommission.chairperson'
        db.delete_column('core_ethicscommission', 'chairperson')
        
        # Deleting field 'EthicsCommission.phone'
        db.delete_column('core_ethicscommission', 'phone')
