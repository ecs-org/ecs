...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.session_key'
        db.add_column('core_userprofile', 'session_key', self.gf('django.db.models.fields.CharField')(max_length=40, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.session_key'
        db.delete_column('core_userprofile', 'session_key')
