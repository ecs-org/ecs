...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotificationType.model'
        db.add_column('core_notificationtype', 'model', orm['core.notificationtype:model'])
        
        # Adding field 'NotificationType.form'
        db.add_column('core_notificationtype', 'form', orm['core.notificationtype:form'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'NotificationType.model'
        db.delete_column('core_notificationtype', 'model')
        
        # Deleting field 'NotificationType.form'
        db.delete_column('core_notificationtype', 'form')
