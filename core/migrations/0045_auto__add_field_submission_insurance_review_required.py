...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.insurance_review_required'
        db.add_column('core_submission', 'insurance_review_required', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.insurance_review_required'
        db.delete_column('core_submission', 'insurance_review_required')
