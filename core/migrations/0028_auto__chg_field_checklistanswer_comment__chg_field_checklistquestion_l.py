...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_checklistanswer', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'ChecklistQuestion.link'
        db.alter_column('core_checklistquestion', 'link', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))

        # Changing field 'ChecklistQuestion.description'
        db.alter_column('core_checklistquestion', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'ChecklistAnswer.comment'
        db.alter_column('core_checklistanswer', 'comment', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'ChecklistQuestion.link'
        db.alter_column('core_checklistquestion', 'link', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
