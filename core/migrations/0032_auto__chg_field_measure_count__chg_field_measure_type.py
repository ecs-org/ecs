...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measure.count'
        db.alter_column('core_measure', 'count', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Measure.type'
        db.alter_column('core_measure', 'type', self.gf('django.db.models.fields.CharField')(max_length=150))
    
    
    def backwards(self, orm):
        
        # Changing field 'Measure.count'
        db.alter_column('core_measure', 'count', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Measure.type'
        db.alter_column('core_measure', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))
