...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.submitter_agrees_to_publishing'
        db.add_column('core_submissionform', 'submitter_agrees_to_publishing', orm['core.submissionform:submitter_agrees_to_publishing'])
        
        # Deleting field 'SubmissionForm.investigator_jus_practicandi'
        db.delete_column('core_submissionform', 'investigator_jus_practicandi')
        
        # Deleting field 'SubmissionForm.isrctn_number'
        db.delete_column('core_submissionform', 'isrctn_number')
        
        # Deleting field 'SubmissionForm.protocol_number'
        db.delete_column('core_submissionform', 'protocol_number')
        
        # Deleting field 'SubmissionForm.study_plan_8_1_4'
        db.delete_column('core_submissionform', 'study_plan_8_1_4')
        
        # Deleting field 'SubmissionForm.investigator_email'
        db.delete_column('core_submissionform', 'investigator_email')
        
        # Deleting field 'SubmissionForm.investigator_fax'
        db.delete_column('core_submissionform', 'investigator_fax')
        
        # Deleting field 'SubmissionForm.investigator_organisation'
        db.delete_column('core_submissionform', 'investigator_organisation')
        
        # Deleting field 'SubmissionForm.investigator_specialist'
        db.delete_column('core_submissionform', 'investigator_specialist')
        
        # Deleting field 'SubmissionForm.date_of_protocol'
        db.delete_column('core_submissionform', 'date_of_protocol')
        
        # Deleting field 'SubmissionForm.investigator_name'
        db.delete_column('core_submissionform', 'investigator_name')
        
        # Deleting field 'SubmissionForm.investigator_mobile'
        db.delete_column('core_submissionform', 'investigator_mobile')
        
        # Deleting field 'SubmissionForm.investigator_phone'
        db.delete_column('core_submissionform', 'investigator_phone')
        
        # Deleting field 'SubmissionForm.study_plan_8_1_8'
        db.delete_column('core_submissionform', 'study_plan_8_1_8')
        
        # Deleting field 'SubmissionForm.investigator_certified'
        db.delete_column('core_submissionform', 'investigator_certified')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.submitter_agrees_to_publishing'
        db.delete_column('core_submissionform', 'submitter_agrees_to_publishing')
        
        # Adding field 'SubmissionForm.investigator_jus_practicandi'
        db.add_column('core_submissionform', 'investigator_jus_practicandi', orm['core.submissionform:investigator_jus_practicandi'])
        
        # Adding field 'SubmissionForm.isrctn_number'
        db.add_column('core_submissionform', 'isrctn_number', orm['core.submissionform:isrctn_number'])
        
        # Adding field 'SubmissionForm.protocol_number'
        db.add_column('core_submissionform', 'protocol_number', orm['core.submissionform:protocol_number'])
        
        # Adding field 'SubmissionForm.study_plan_8_1_4'
        db.add_column('core_submissionform', 'study_plan_8_1_4', orm['core.submissionform:study_plan_8_1_4'])
        
        # Adding field 'SubmissionForm.investigator_email'
        db.add_column('core_submissionform', 'investigator_email', orm['core.submissionform:investigator_email'])
        
        # Adding field 'SubmissionForm.investigator_fax'
        db.add_column('core_submissionform', 'investigator_fax', orm['core.submissionform:investigator_fax'])
        
        # Adding field 'SubmissionForm.investigator_organisation'
        db.add_column('core_submissionform', 'investigator_organisation', orm['core.submissionform:investigator_organisation'])
        
        # Adding field 'SubmissionForm.investigator_specialist'
        db.add_column('core_submissionform', 'investigator_specialist', orm['core.submissionform:investigator_specialist'])
        
        # Adding field 'SubmissionForm.date_of_protocol'
        db.add_column('core_submissionform', 'date_of_protocol', orm['core.submissionform:date_of_protocol'])
        
        # Adding field 'SubmissionForm.investigator_name'
        db.add_column('core_submissionform', 'investigator_name', orm['core.submissionform:investigator_name'])
        
        # Adding field 'SubmissionForm.investigator_mobile'
        db.add_column('core_submissionform', 'investigator_mobile', orm['core.submissionform:investigator_mobile'])
        
        # Adding field 'SubmissionForm.investigator_phone'
        db.add_column('core_submissionform', 'investigator_phone', orm['core.submissionform:investigator_phone'])
        
        # Adding field 'SubmissionForm.study_plan_8_1_8'
        db.add_column('core_submissionform', 'study_plan_8_1_8', orm['core.submissionform:study_plan_8_1_8'])
        
        # Adding field 'SubmissionForm.investigator_certified'
        db.add_column('core_submissionform', 'investigator_certified', orm['core.submissionform:investigator_certified'])
