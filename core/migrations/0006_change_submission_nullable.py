...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.submissionreview'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.SubmissionReview'], null=True))
        db.alter_column('core_submission', 'submissionreview_id', orm['core.submission:submissionreview'])
        
        # Changing field 'Submission.vote'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Vote'], null=True))
        db.alter_column('core_submission', 'vote_id', orm['core.submission:vote'])
        
        # Changing field 'Submission.workflow'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Workflow'], null=True))
        db.alter_column('core_submission', 'workflow_id', orm['core.submission:workflow'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Submission.submissionreview'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.SubmissionReview']))
        db.alter_column('core_submission', 'submissionreview_id', orm['core.submission:submissionreview'])
        
        # Changing field 'Submission.vote'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Vote']))
        db.alter_column('core_submission', 'vote_id', orm['core.submission:vote'])
