...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_documenttype', 'name', orm['core.documenttype:name'])
        
        # Changing field 'Document.version'
        # (to signature: django.db.models.fields.CharField(max_length=250))
        db.alter_column('core_document', 'version', orm['core.document:version'])
