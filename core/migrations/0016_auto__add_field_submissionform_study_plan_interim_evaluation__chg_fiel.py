...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.study_plan_interim_evaluation'
        db.add_column('core_submissionform', 'study_plan_interim_evaluation', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'SubmissionForm.study_plan_abort_crit'
        db.alter_column('core_submissionform', 'study_plan_abort_crit', self.gf('django.db.models.fields.CharField')(max_length=265, null=True))


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.study_plan_interim_evaluation'
        db.delete_column('core_submissionform', 'study_plan_interim_evaluation')
