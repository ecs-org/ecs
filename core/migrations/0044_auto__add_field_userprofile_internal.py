...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.internal'
        db.add_column('core_userprofile', 'internal', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.internal'
        db.delete_column('core_userprofile', 'internal')
