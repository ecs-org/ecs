...
#            study_plan_8_1_22="response, survival, toxicity",
        ...
        sform.save()
        ek1 = orm.EthicsCommission.objects.filter(name="Ethikkomission der Medizinischen Universität Wien")[0]
        involved_com = orm.InvolvedCommissionsForSubmission(commission=ek1, submission=sform, main=True, examiner_name="Univ. Doz. Dr. Ruth Ladenstein")
