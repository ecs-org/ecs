...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.protocol_number'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'protocol_number', orm['core.submissionform:protocol_number'])
        
        # Changing field 'SubmissionForm.eudract_number'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'eudract_number', orm['core.submissionform:eudract_number'])
        
        # Changing field 'SubmissionForm.sponsor_name'
        # (to signature: django.db.models.fields.CharField(max_length=80, null=True))
        db.alter_column('core_submissionform', 'sponsor_name', orm['core.submissionform:sponsor_name'])
        
        # Changing field 'SubmissionForm.isrctn_number'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'isrctn_number', orm['core.submissionform:isrctn_number'])
