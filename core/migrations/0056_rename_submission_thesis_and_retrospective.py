...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('core_submission', 'thesis', 'is_thesis')
        db.rename_column('core_submission', 'retrospective', 'is_retrospective')


    def backwards(self, orm):
        db.rename_column('core_submission', 'is_thesis', 'thesis')
        db.rename_column('core_submission', 'is_retrospective', 'retrospective')
