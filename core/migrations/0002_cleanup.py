...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionReview.workflow'
        db.delete_column('core_submissionreview', 'workflow_id')

        # Deleting field 'NotificationAnswer.workflow'
        db.delete_column('core_notificationanswer', 'workflow_id')

        # Deleting field 'Submission.submissionreview'
        db.delete_column('core_submission', 'submissionreview_id')

        # Deleting field 'Submission.vote'
        db.delete_column('core_submission', 'vote_id')

        # Deleting field 'Submission.workflow'
        db.delete_column('core_submission', 'workflow_id')

        # Deleting field 'Vote.workflow'
        db.delete_column('core_vote', 'workflow_id')

        # Changing field 'EthicsCommission.city'
        db.alter_column('core_ethicscommission', 'city', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'EthicsCommission.fax'
        db.alter_column('core_ethicscommission', 'fax', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'EthicsCommission.name'
        db.alter_column('core_ethicscommission', 'name', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'EthicsCommission.phone'
        db.alter_column('core_ethicscommission', 'phone', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'EthicsCommission.address_1'
        db.alter_column('core_ethicscommission', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'EthicsCommission.address_2'
        db.alter_column('core_ethicscommission', 'address_2', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Deleting field 'VoteReview.workflow'
        db.delete_column('core_votereview', 'workflow_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'SubmissionReview.workflow'
        db.add_column('core_submissionreview', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Workflow']), keep_default=False)

        # Adding field 'NotificationAnswer.workflow'
        db.add_column('core_notificationanswer', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Workflow']), keep_default=False)

        # Adding field 'Submission.submissionreview'
        db.add_column('core_submission', 'submissionreview', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.SubmissionReview'], null=True), keep_default=False)

        # Adding field 'Submission.vote'
        db.add_column('core_submission', 'vote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Vote'], null=True), keep_default=False)

        # Adding field 'Submission.workflow'
        db.add_column('core_submission', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Workflow'], null=True), keep_default=False)

        # Adding field 'Vote.workflow'
        db.add_column('core_vote', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Workflow']), keep_default=False)

        # Changing field 'EthicsCommission.city'
        db.alter_column('core_ethicscommission', 'city', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'EthicsCommission.fax'
        db.alter_column('core_ethicscommission', 'fax', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'EthicsCommission.name'
        db.alter_column('core_ethicscommission', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'EthicsCommission.phone'
        db.alter_column('core_ethicscommission', 'phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'EthicsCommission.address_1'
        db.alter_column('core_ethicscommission', 'address_1', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'EthicsCommission.address_2'
        db.alter_column('core_ethicscommission', 'address_2', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Adding field 'VoteReview.workflow'
        db.add_column('core_votereview', 'workflow', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['core.Workflow']), keep_default=False)
