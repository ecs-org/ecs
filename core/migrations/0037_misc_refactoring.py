...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.submission_form'
        db.add_column('core_vote', 'submission_form', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='votes', to=orm['core.SubmissionForm']), keep_default=False)

        # Adding field 'Submission.current_submission_form'
        db.add_column('core_submission', 'current_submission_form', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_current_for', unique=True, null=True, to=orm['core.SubmissionForm']), keep_default=False)

        # Adding field 'Investigator.user'
        db.add_column('core_investigator', 'user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='investigations', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'SubmissionForm.primary_investigator'
        db.add_column('core_submissionform', 'primary_investigator', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Investigator'], unique=True, null=True), keep_default=False)

        # Adding field 'SubmissionForm.current_published_vote'
        db.add_column('core_submissionform', 'current_published_vote', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_currently_published_for', unique=True, null=True, to=orm['core.Vote']), keep_default=False)

        # Adding field 'SubmissionForm.current_pending_vote'
        db.add_column('core_submissionform', 'current_pending_vote', self.gf('django.db.models.fields.related.OneToOneField')(related_name='_currently_pending_for', unique=True, null=True, to=orm['core.Vote']), keep_default=False)

        # Adding field 'SubmissionForm.sponsor'
        db.add_column('core_submissionform', 'sponsor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sponsored_submission_forms', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'SubmissionForm.submitter'
        db.add_column('core_submissionform', 'submitter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submitted_submission_forms', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.submission_form'
        db.delete_column('core_vote', 'submission_form_id')

        # Deleting field 'Submission.current_submission_form'
        db.delete_column('core_submission', 'current_submission_form_id')

        # Deleting field 'Investigator.user'
        db.delete_column('core_investigator', 'user_id')

        # Deleting field 'SubmissionForm.primary_investigator'
        db.delete_column('core_submissionform', 'primary_investigator_id')

        # Deleting field 'SubmissionForm.current_published_vote'
        db.delete_column('core_submissionform', 'current_published_vote_id')

        # Deleting field 'SubmissionForm.current_pending_vote'
        db.delete_column('core_submissionform', 'current_pending_vote_id')

        # Deleting field 'SubmissionForm.sponsor'
        db.delete_column('core_submissionform', 'sponsor_id')

        # Deleting field 'SubmissionForm.submitter'
        db.delete_column('core_submissionform', 'submitter_id')
    ...
    models = {
        ...
        'core.submission': {
            ...
            'current_submission_form': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'_current_for'", 'unique': 'True', 'null': 'True', 'to': "orm['core.SubmissionForm']"}),
            ...
            'remission': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'core.submissionform': {
            ...
            'submitter_agrees_to_publishing': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
