...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'ChecklistQuestion', fields ['blueprint', 'index']
        db.delete_unique('core_checklistquestion', ['blueprint_id', 'index'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'ChecklistQuestion', fields ['blueprint', 'index']
        db.create_unique('core_checklistquestion', ['blueprint_id', 'index'])
