...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemporaryAuthorization'
        db.create_table('core_temporaryauthorization', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='temp_auth', to=orm['core.Submission'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='temp_submission_auth', to=orm['auth.User'])),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('core', ['TemporaryAuthorization'])


    def backwards(self, orm):
        
        # Deleting model 'TemporaryAuthorization'
        db.delete_table('core_temporaryauthorization')
