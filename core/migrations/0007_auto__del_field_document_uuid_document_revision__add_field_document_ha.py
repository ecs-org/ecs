...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Document.uuid_document_revision'
        db.delete_column('core_document', 'uuid_document_revision')

        # Adding field 'Document.hash'
        db.add_column('core_document', 'hash', self.gf('django.db.models.fields.SlugField')(default='', max_length=32, db_index=True), keep_default=False)

        # Changing field 'Document.uuid_document'
        db.alter_column('core_document', 'uuid_document', self.gf('django.db.models.fields.SlugField')(max_length=36))
    
    
    def backwards(self, orm):
        
        # Adding field 'Document.uuid_document_revision'
        db.add_column('core_document', 'uuid_document_revision', self.gf('django.db.models.fields.SlugField')(default='', max_length=32, db_index=True), keep_default=False)

        # Deleting field 'Document.hash'
        db.delete_column('core_document', 'hash')

        # Changing field 'Document.uuid_document'
        db.alter_column('core_document', 'uuid_document', self.gf('django.db.models.fields.SlugField')(max_length=32))
