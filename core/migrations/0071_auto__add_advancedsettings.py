...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdvancedSettings'
        db.create_table('core_advancedsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('default_contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
        db.send_create_signal('core', ['AdvancedSettings'])


    def backwards(self, orm):
        
        # Deleting model 'AdvancedSettings'
        db.delete_table('core_advancedsettings')
    ...
    models = {
        ...
        'core.advancedsettings': {
            ...
            'default_contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 4, 15, 28, 35, 252277)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
