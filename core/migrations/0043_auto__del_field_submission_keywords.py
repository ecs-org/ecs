...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_submission', 'keywords')


    def backwards(self, orm):
        
        # Adding field 'Submission.keywords'
        db.add_column('core_submission', 'keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
