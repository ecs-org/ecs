...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.min_document_count'
        db.add_column('core_checklistblueprint', 'min_document_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Checklist.document'
        db.add_column('core_checklist', 'document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.min_document_count'
        db.delete_column('core_checklistblueprint', 'min_document_count')

        # Deleting field 'Checklist.document'
        db.delete_column('core_checklist', 'document_id')
