...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.submitter_email'
        db.add_column('core_submissionform', 'submitter_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.submitter_email'
        db.delete_column('core_submissionform', 'submitter_email')
