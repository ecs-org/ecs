...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.new_ec_number'
        db.add_column('core_submission', 'new_ec_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=20109999, unique=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.new_ec_number'
        db.delete_column('core_submission', 'new_ec_number')
    ...
    models = {
        ...
        'core.submission': {
            ...
            'new_ec_number': ('django.db.models.fields.PositiveIntegerField', [], {'unique': 'True', 'db_index': 'True'}),
