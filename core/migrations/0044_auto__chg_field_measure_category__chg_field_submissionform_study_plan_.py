...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Measure.category'
        db.alter_column('core_measure', 'category', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'SubmissionForm.study_plan_blind'
        db.alter_column('core_submissionform', 'study_plan_blind', self.gf('django.db.models.fields.SmallIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Measure.category'
        db.alter_column('core_measure', 'category', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'SubmissionForm.study_plan_blind'
        db.alter_column('core_submissionform', 'study_plan_blind', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
