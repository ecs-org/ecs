...
class Migration:
    ...
    def forwards(self, orm):
        orm.NotificationType.objects.filter(name=u"Jahresbericht").update(name=u"Zwischenbericht")
        orm.NotificationType.objects.filter(name=u"Protokolländerung").update(form='ecs.core.forms.NotificationForm')
        orm.NotificationType.objects.filter(name=u"Ergänzungsreport").delete()
