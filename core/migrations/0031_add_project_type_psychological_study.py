...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.project_type_psychological_study'
        db.add_column('core_submissionform', 'project_type_psychological_study', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.project_type_psychological_study'
        db.delete_column('core_submissionform', 'project_type_psychological_study')
