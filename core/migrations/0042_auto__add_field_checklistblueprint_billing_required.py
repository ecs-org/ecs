...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ChecklistBlueprint.billing_required'
        db.add_column('core_checklistblueprint', 'billing_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ChecklistBlueprint.billing_required'
        db.delete_column('core_checklistblueprint', 'billing_required')
