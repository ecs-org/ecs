...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.subject_maxage'
        db.alter_column('core_submissionform', 'subject_maxage', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SubmissionForm.subject_minage'
        db.alter_column('core_submissionform', 'subject_minage', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.subject_maxage'
        db.alter_column('core_submissionform', 'subject_maxage', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'SubmissionForm.subject_minage'
        db.alter_column('core_submissionform', 'subject_minage', self.gf('django.db.models.fields.IntegerField')())
