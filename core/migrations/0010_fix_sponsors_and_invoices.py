...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.invoice_contactname'
        db.add_column('core_submissionform', 'invoice_contactname', orm['core.submissionform:invoice_contactname'])
        
        # Adding field 'SubmissionForm.sponsor_contactname'
        db.add_column('core_submissionform', 'sponsor_contactname', orm['core.submissionform:sponsor_contactname'])
        
        # Changing field 'SubmissionForm.invoice_uid'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'invoice_uid', orm['core.submissionform:invoice_uid'])
        
        # Changing field 'SubmissionForm.sponsor_fax'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'sponsor_fax', orm['core.submissionform:sponsor_fax'])
        
        # Changing field 'SubmissionForm.sponsor_phone'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'sponsor_phone', orm['core.submissionform:sponsor_phone'])
        
        # Changing field 'SubmissionForm.invoice_city'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'invoice_city', orm['core.submissionform:invoice_city'])
        
        # Changing field 'SubmissionForm.invoice_phone'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'invoice_phone', orm['core.submissionform:invoice_phone'])
        
        # Changing field 'SubmissionForm.invoice_address1'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'invoice_address1', orm['core.submissionform:invoice_address1'])
        
        # Changing field 'SubmissionForm.sponsor_city'
        # (to signature: django.db.models.fields.CharField(max_length=40, null=True))
        db.alter_column('core_submissionform', 'sponsor_city', orm['core.submissionform:sponsor_city'])
        
        # Changing field 'SubmissionForm.sponsor_email'
        # (to signature: django.db.models.fields.EmailField(max_length=75, null=True))
        db.alter_column('core_submissionform', 'sponsor_email', orm['core.submissionform:sponsor_email'])
        
        # Changing field 'SubmissionForm.invoice_fax'
        # (to signature: django.db.models.fields.CharField(max_length=30, null=True))
        db.alter_column('core_submissionform', 'invoice_fax', orm['core.submissionform:invoice_fax'])
        
        # Changing field 'SubmissionForm.sponsor_zip_code'
        # (to signature: django.db.models.fields.CharField(max_length=10, null=True))
        db.alter_column('core_submissionform', 'sponsor_zip_code', orm['core.submissionform:sponsor_zip_code'])
        
        # Changing field 'SubmissionForm.invoice_zip_code'
        # (to signature: django.db.models.fields.CharField(max_length=10, null=True))
        db.alter_column('core_submissionform', 'invoice_zip_code', orm['core.submissionform:invoice_zip_code'])
        
        # Changing field 'SubmissionForm.invoice_email'
        # (to signature: django.db.models.fields.EmailField(max_length=75, null=True))
        db.alter_column('core_submissionform', 'invoice_email', orm['core.submissionform:invoice_email'])
        
        # Changing field 'SubmissionForm.invoice_address2'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'invoice_address2', orm['core.submissionform:invoice_address2'])
        
        # Changing field 'SubmissionForm.sponsor_address1'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'sponsor_address1', orm['core.submissionform:sponsor_address1'])
        
        # Changing field 'SubmissionForm.invoice_name'
        # (to signature: django.db.models.fields.CharField(max_length=80, null=True))
        db.alter_column('core_submissionform', 'invoice_name', orm['core.submissionform:invoice_name'])
        
        # Changing field 'SubmissionForm.sponsor_address2'
        # (to signature: django.db.models.fields.CharField(max_length=60, null=True))
        db.alter_column('core_submissionform', 'sponsor_address2', orm['core.submissionform:sponsor_address2'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.invoice_contactname'
        db.delete_column('core_submissionform', 'invoice_contactname')
        
        # Deleting field 'SubmissionForm.sponsor_contactname'
        db.delete_column('core_submissionform', 'sponsor_contactname')
