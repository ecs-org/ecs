...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.submission'
        db.add_column('core_submissionform', 'submission', orm['core.submissionform:submission'])
        
        # Adding ManyToManyField 'SubmissionForm.documents'
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubmissionForm.submission'
        db.delete_column('core_submissionform', 'submission_id')
        
        # Dropping ManyToManyField 'SubmissionForm.documents'
