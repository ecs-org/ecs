...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.submissionform'
        db.add_column('core_vote', 'submissionform', orm['core.vote:submissionform'])
        
        # Deleting field 'Vote.submissionset'
        db.delete_column('core_vote', 'submissionset_id')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Vote.submissionform'
        db.delete_column('core_vote', 'submissionform_id')
        
        # Adding field 'Vote.submissionset'
        db.add_column('core_vote', 'submissionset', orm['core.vote:submissionset'])
        
        # Adding model 'submissionset'
        db.create_table('core_submissionset', (
            ('submissionform', orm['core.vote:submissionform']),
            ('documents', orm['core.vote:documents']),
            ('id', orm['core.vote:id']),
            ('submission', orm['core.vote:submission']),
        ))
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'forms'", 'null': 'True', 'to': "orm['core.Submission']"}),
