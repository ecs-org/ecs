...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.susar_presenter'
        db.alter_column('core_submission', 'susar_presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Submission.presenter'
        db.alter_column('core_submission', 'presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Submission.susar_presenter'
        db.alter_column('core_submission', 'susar_presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Submission.presenter'
        db.alter_column('core_submission', 'presenter_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 12, 16, 26, 54, 896741)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
