...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.insurance_review_required'
        db.alter_column('core_submission', 'insurance_review_required', self.gf('django.db.models.fields.NullBooleanField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Submission.insurance_review_required'
        db.alter_column('core_submission', 'insurance_review_required', self.gf('django.db.models.fields.BooleanField')())
