...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('core_investigator', 'submission_id', 'submission_form_id')
        db.delete_column('core_investigator', 'sign_date')
    
    
    def backwards(self, orm):
        db.rename_column('core_investigator', 'submission_form_id', 'submission_id')
        db.add_column('core_investigator', 'sign_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 5, 2)), keep_default=False)
