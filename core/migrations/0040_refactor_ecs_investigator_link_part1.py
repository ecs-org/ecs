...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Investigator.commission'
        db.add_column('core_investigator', 'commission', orm['core.investigator:commission'])
        
        # Adding field 'Investigator.main_investigator'
        db.add_column('core_investigator', 'main_investigator', orm['core.investigator:main_investigator'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Investigator.commission'
        db.delete_column('core_investigator', 'commission_id')
        
        # Deleting field 'Investigator.main_investigator'
        db.delete_column('core_investigator', 'main_investigator')
