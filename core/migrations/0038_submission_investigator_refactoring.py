...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Investigator.main'
        db.add_column('core_investigator', 'main', orm['core.investigator:main'])
        
        # Adding field 'Investigator.ethics_commission'
        db.add_column('core_investigator', 'ethics_commission', orm['core.investigator:ethics_commission'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Investigator.main'
        db.delete_column('core_investigator', 'main')
        
        # Deleting field 'Investigator.ethics_commission'
        db.delete_column('core_investigator', 'ethics_commission_id')
