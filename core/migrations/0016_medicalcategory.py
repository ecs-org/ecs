...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MedicalCategory.expeditedreview'
        db.delete_column('core_medicalcategory', 'expeditedreview')

        # Changing field 'MedicalCategory.abbrev'
        db.alter_column('core_medicalcategory', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=12))
    
    
    def backwards(self, orm):
        
        # Adding field 'MedicalCategory.expeditedreview'
        db.add_column('core_medicalcategory', 'expeditedreview', self.gf('django.db.models.fields.CharField')(default='rofl', max_length=2), keep_default=False)

        # Changing field 'MedicalCategory.abbrev'
        db.alter_column('core_medicalcategory', 'abbrev', self.gf('django.db.models.fields.CharField')(max_length=8))
