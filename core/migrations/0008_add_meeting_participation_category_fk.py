...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participation.medical_category'
        db.add_column('core_participation', 'medical_category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='meeting_participations', null=True, to=orm['core.MedicalCategory']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Participation.medical_category'
        db.delete_column('core_participation', 'medical_category_id')
