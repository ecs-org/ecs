...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvolvedCommissionsForSubmission.examiner_name'
        db.add_column('core_involvedcommissionsforsubmission', 'examiner_name', orm['core.involvedcommissionsforsubmission:examiner_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'InvolvedCommissionsForSubmission.examiner_name'
        db.delete_column('core_involvedcommissionsforsubmission', 'examiner_name')
