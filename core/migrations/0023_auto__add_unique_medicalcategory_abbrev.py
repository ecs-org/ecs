...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MedicalCategory', fields ['abbrev']
        db.create_unique('core_medicalcategory', ['abbrev'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'MedicalCategory', fields ['abbrev']
        db.delete_unique('core_medicalcategory', ['abbrev'])
