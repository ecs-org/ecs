...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.acknowledged'
        db.add_column('core_submissionform', 'acknowledged', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.acknowledged'
        db.delete_column('core_submissionform', 'acknowledged')
