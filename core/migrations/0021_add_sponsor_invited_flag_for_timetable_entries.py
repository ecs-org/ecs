...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimetableEntry.sponsor_invited'
        db.add_column('core_timetableentry', 'sponsor_invited', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TimetableEntry.sponsor_invited'
        db.delete_column('core_timetableentry', 'sponsor_invited')
