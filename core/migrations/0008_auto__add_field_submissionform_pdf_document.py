...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.pdf_document'
        db.add_column('core_submissionform', 'pdf_document', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submission_forms', null=True, to=orm['core.Document']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.pdf_document'
        db.delete_column('core_submissionform', 'pdf_document_id')
