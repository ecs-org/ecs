...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('core_submissionform', 'submitter_agrees_to_publishing', 'sponsor_agrees_to_publishing')


    def backwards(self, orm):
        db.rename_column('core_submissionform', 'sponsor_agrees_to_publishing', 'submitter_agrees_to_publishing')
