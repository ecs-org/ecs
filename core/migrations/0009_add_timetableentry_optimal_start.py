...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimetableEntry.optimal_start'
        db.add_column('core_timetableentry', 'optimal_start', self.gf('django.db.models.fields.TimeField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TimetableEntry.optimal_start'
        db.delete_column('core_timetableentry', 'optimal_start')
