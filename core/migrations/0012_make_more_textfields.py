...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.pharma_reference_substance'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'pharma_reference_substance', orm['core.submissionform:pharma_reference_substance'])
        
        # Changing field 'SubmissionForm.pharma_checked_substance'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'pharma_checked_substance', orm['core.submissionform:pharma_checked_substance'])
