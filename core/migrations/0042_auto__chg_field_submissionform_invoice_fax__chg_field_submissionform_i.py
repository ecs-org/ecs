...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_submissionform', 'invoice_fax', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True))

        # Changing field 'SubmissionForm.invoice_phone'
        db.alter_column('core_submissionform', 'invoice_phone', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.invoice_fax'
        db.alter_column('core_submissionform', 'invoice_fax', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True))

        # Changing field 'SubmissionForm.invoice_phone'
        db.alter_column('core_submissionform', 'invoice_phone', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True))
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'invoice_name': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
