...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute_many('''
            drop table if exists audit_audittrail;
            delete from auth_permission where content_type_id in (
                select id from django_content_type where app_label = 'audit');
            delete from django_content_type where app_label = 'audit';
        ''')
    ...
    depends_on = (
        ('votes', '0007_version_history_with_reversion'),
        ('notifications', '0034_version_history_with_reversion'),
    )
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 18, 11, 7, 42, 9334)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
