...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute('''
create view core_mysubmission as (
  select distinct
    unnest(array[
  ...
  left join core_investigator inv on inv.id = sf.primary_investigator_id
    ...
    def backwards(self, orm):
        db.execute('drop view core_mysubmission')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 20, 14, 33, 24, 977626)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
