...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for o in orm.Submission.objects.filter(submissionreview=None,
                                               vote=None,
                                               workflow=None):
            for s in o.sets.filter(submissionform__study_plan_dataprotection_anonalgoritm="to long"):
                s.submissionform.study_plan_dataprotection_anonalgoritm = "Electronically generated unique patient number within SIOPEN-R-Net"
                s.submissionform.save()
            for s in o.sets.filter(submissionform__substance_p_c_t_period="to long"):
                s.submissionform.substance_p_c_t_period = "Anti-GD2-Phase I: 1989-1992, Phase III 2002"
                s.submissionform.save()
    ...
    def backwards(self, orm):
        ...
        for o in orm.Submission.objects.filter(submissionreview=None,
                                               vote=None,
                                               workflow=None):
            for s in o.sets.filter(submissionform__study_plan_dataprotection_anonalgoritm="Electronically generated unique patient number within SIOPEN-R-Net"):
                s.submissionform.study_plan_dataprotection_anonalgoritm = "to long"
                s.submissionform.save()
            for s in o.sets.filter(submissionform__substance_p_c_t_period="Anti-GD2-Phase I: 1989-1992, Phase III 2002"):
                s.submissionform.substance_p_c_t_period = "to long"
                s.submissionform.save()
