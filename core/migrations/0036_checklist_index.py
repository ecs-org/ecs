...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for blueprint in orm.ChecklistBlueprint.objects.all():
            for i, question in enumerate(sorted(blueprint.questions.all(), key=_question_key)):
                question.index = i
                question.save()
