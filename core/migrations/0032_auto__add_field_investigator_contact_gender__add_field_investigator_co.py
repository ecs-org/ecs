...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Investigator.contact_gender'
        db.add_column('core_investigator', 'contact_gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Investigator.contact_first_name'
        db.add_column('core_investigator', 'contact_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Investigator.contact_last_name'
        db.add_column('core_investigator', 'contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.invoice_contact_gender'
        db.add_column('core_submissionform', 'invoice_contact_gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.invoice_contact_first_name'
        db.add_column('core_submissionform', 'invoice_contact_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.invoice_contact_last_name'
        db.add_column('core_submissionform', 'invoice_contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.sponsor_contact_gender'
        db.add_column('core_submissionform', 'sponsor_contact_gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.sponsor_contact_first_name'
        db.add_column('core_submissionform', 'sponsor_contact_first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.sponsor_contact_last_name'
        db.add_column('core_submissionform', 'sponsor_contact_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Investigator.contact_gender'
        db.delete_column('core_investigator', 'contact_gender')

        # Deleting field 'Investigator.contact_first_name'
        db.delete_column('core_investigator', 'contact_first_name')

        # Deleting field 'Investigator.contact_last_name'
        db.delete_column('core_investigator', 'contact_last_name')

        # Deleting field 'SubmissionForm.invoice_contact_gender'
        db.delete_column('core_submissionform', 'invoice_contact_gender')

        # Deleting field 'SubmissionForm.invoice_contact_first_name'
        db.delete_column('core_submissionform', 'invoice_contact_first_name')

        # Deleting field 'SubmissionForm.invoice_contact_last_name'
        db.delete_column('core_submissionform', 'invoice_contact_last_name')

        # Deleting field 'SubmissionForm.sponsor_contact_gender'
        db.delete_column('core_submissionform', 'sponsor_contact_gender')

        # Deleting field 'SubmissionForm.sponsor_contact_first_name'
        db.delete_column('core_submissionform', 'sponsor_contact_first_name')

        # Deleting field 'SubmissionForm.sponsor_contact_last_name'
        db.delete_column('core_submissionform', 'sponsor_contact_last_name')
