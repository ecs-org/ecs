...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.status'
        db.add_column('core_checklist', 'status', self.gf('django.db.models.fields.CharField')(default='new', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Checklist.status'
        db.delete_column('core_checklist', 'status')
