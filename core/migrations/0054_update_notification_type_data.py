...
class Migration:
    ...
    def forwards(self, orm):
        orm.NotificationType.objects.update(form='ecs.core.forms.NotificationForm')
        orm.NotificationType.objects.filter(name=u'Jahresbericht').update(form='ecs.core.forms.ProgressReportNotificationForm')
        orm.NotificationType.objects.filter(name=u'Abschlussbericht').update(form='ecs.core.forms.CompletionReportNotificationForm')
        orm.NotificationType.objects.create(name=u'Protokolländerung', form='ecs.core.forms.CompletionReportNotificationForm')
