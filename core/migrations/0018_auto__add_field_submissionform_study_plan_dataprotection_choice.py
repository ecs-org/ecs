...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.study_plan_dataprotection_choice'
        db.add_column('core_submissionform', 'study_plan_dataprotection_choice', self.gf('django.db.models.fields.CharField')(default='non-personal', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.study_plan_dataprotection_choice'
        db.delete_column('core_submissionform', 'study_plan_dataprotection_choice')
