...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Vote.published'
        db.delete_column('core_vote', 'published')

        # Adding field 'Vote.published_at'
        db.add_column('core_vote', 'published_at', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Vote.published'
        db.add_column('core_vote', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Vote.published_at'
        db.delete_column('core_vote', 'published_at')
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'_submission_forms'", 'null': 'True', 'to': "orm['documents.Document']"}),
