...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Submission.external_reviewer_name'
        db.alter_column('core_submission', 'external_reviewer_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True))
        ...
        # Changing field 'SubmissionForm.medtech_product_name'
        db.alter_column('core_submissionform', 'medtech_product_name', self.gf('django.db.models.fields.CharField')(max_length=210, null=True, blank=True))

        # Changing field 'SubmissionForm.study_plan_alpha'
        db.alter_column('core_submissionform', 'study_plan_alpha', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.eudract_number'
        db.alter_column('core_submissionform', 'eudract_number', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'SubmissionForm.study_plan_dropout_ratio'
        db.alter_column('core_submissionform', 'study_plan_dropout_ratio', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.study_plan_planned_statalgorithm'
        db.alter_column('core_submissionform', 'study_plan_planned_statalgorithm', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'SubmissionForm.study_plan_statalgorithm'
        db.alter_column('core_submissionform', 'study_plan_statalgorithm', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'SubmissionForm.sponsor_name'
        db.alter_column('core_submissionform', 'sponsor_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'SubmissionForm.subject_duration'
        db.alter_column('core_submissionform', 'subject_duration', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'SubmissionForm.subject_planned_total_duration'
        db.alter_column('core_submissionform', 'subject_planned_total_duration', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.study_plan_power'
        db.alter_column('core_submissionform', 'study_plan_power', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.sponsor_city'
        db.alter_column('core_submissionform', 'sponsor_city', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
        ...
        # Changing field 'SubmissionForm.subject_duration_active'
        db.alter_column('core_submissionform', 'subject_duration_active', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'SubmissionForm.subject_duration_controls'
        db.alter_column('core_submissionform', 'subject_duration_controls', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'SubmissionForm.submitter_jobtitle'
        db.alter_column('core_submissionform', 'submitter_jobtitle', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SubmissionForm.invoice_city'
        db.alter_column('core_submissionform', 'invoice_city', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))

        # Changing field 'SubmissionForm.substance_p_c_t_application_type'
        db.alter_column('core_submissionform', 'substance_p_c_t_application_type', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))

        # Changing field 'SubmissionForm.submitter_organisation'
        db.alter_column('core_submissionform', 'submitter_organisation', self.gf('django.db.models.fields.CharField')(max_length=180))

        # Changing field 'SubmissionForm.study_plan_multiple_test_correction_algorithm'
        db.alter_column('core_submissionform', 'study_plan_multiple_test_correction_algorithm', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SubmissionForm.invoice_name'
        db.alter_column('core_submissionform', 'invoice_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Submission.external_reviewer_name'
        db.alter_column('core_submission', 'external_reviewer_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'SubmissionForm.study_plan_abort_crit'
        db.alter_column('core_submissionform', 'study_plan_abort_crit', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.medtech_product_name'
        db.alter_column('core_submissionform', 'medtech_product_name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))

        # Changing field 'SubmissionForm.study_plan_alpha'
        db.alter_column('core_submissionform', 'study_plan_alpha', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.eudract_number'
        db.alter_column('core_submissionform', 'eudract_number', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'SubmissionForm.study_plan_dropout_ratio'
        db.alter_column('core_submissionform', 'study_plan_dropout_ratio', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.study_plan_planned_statalgorithm'
        db.alter_column('core_submissionform', 'study_plan_planned_statalgorithm', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.study_plan_statalgorithm'
        db.alter_column('core_submissionform', 'study_plan_statalgorithm', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.sponsor_name'
        db.alter_column('core_submissionform', 'sponsor_name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'SubmissionForm.subject_duration'
        db.alter_column('core_submissionform', 'subject_duration', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SubmissionForm.subject_planned_total_duration'
        db.alter_column('core_submissionform', 'subject_planned_total_duration', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SubmissionForm.study_plan_power'
        db.alter_column('core_submissionform', 'study_plan_power', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.sponsor_city'
        db.alter_column('core_submissionform', 'sponsor_city', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'SubmissionForm.study_plan_dataprotection_dvr'
        db.alter_column('core_submissionform', 'study_plan_dataprotection_dvr', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True))

        # Changing field 'SubmissionForm.subject_duration_active'
        db.alter_column('core_submissionform', 'subject_duration_active', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SubmissionForm.subject_duration_controls'
        db.alter_column('core_submissionform', 'subject_duration_controls', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SubmissionForm.submitter_jobtitle'
        db.alter_column('core_submissionform', 'submitter_jobtitle', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.invoice_city'
        db.alter_column('core_submissionform', 'invoice_city', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True))

        # Changing field 'SubmissionForm.substance_p_c_t_application_type'
        db.alter_column('core_submissionform', 'substance_p_c_t_application_type', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True))

        # Changing field 'SubmissionForm.submitter_organisation'
        db.alter_column('core_submissionform', 'submitter_organisation', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'SubmissionForm.study_plan_multiple_test_correction_algorithm'
        db.alter_column('core_submissionform', 'study_plan_multiple_test_correction_algorithm', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'SubmissionForm.invoice_name'
        db.alter_column('core_submissionform', 'invoice_name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'substance_p_c_t_countries': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['countries.Country']"}),
            ...
            'substance_registered_in_countries': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'submission_forms'", 'to': "orm['countries.Country']"})
        },
