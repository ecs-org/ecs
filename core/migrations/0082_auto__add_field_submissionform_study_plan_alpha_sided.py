...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.study_plan_alpha_sided'
        db.add_column('core_submissionform', 'study_plan_alpha_sided', self.gf('django.db.models.fields.SmallIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.study_plan_alpha_sided'
        db.delete_column('core_submissionform', 'study_plan_alpha_sided')
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 21, 17, 17, 8, 445079)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
