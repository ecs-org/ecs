...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checklist.user'
        db.add_column('core_checklist', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=898, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Checklist.user'
        db.delete_column('core_checklist', 'user_id')
