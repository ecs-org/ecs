...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Vote.is_final'
        db.add_column('core_vote', 'is_final', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Vote.is_final'
        db.delete_column('core_vote', 'is_final')
