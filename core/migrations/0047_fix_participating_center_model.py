...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_foreignparticipatingcenter', (
            ('id', orm['core.foreignparticipatingcenter:id']),
            ('submission_form', orm['core.foreignparticipatingcenter:submission_form']),
            ('name', orm['core.foreignparticipatingcenter:name']),
            ('address_1', orm['core.foreignparticipatingcenter:address_1']),
            ('address_2', orm['core.foreignparticipatingcenter:address_2']),
            ('zip_code', orm['core.foreignparticipatingcenter:zip_code']),
            ('city', orm['core.foreignparticipatingcenter:city']),
            ('country', orm['core.foreignparticipatingcenter:country']),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_participatingcenter', (
            ('city', orm['core.foreignparticipatingcenter:city']),
            ('submission', orm['core.foreignparticipatingcenter:submission']),
            ('address_1', orm['core.foreignparticipatingcenter:address_1']),
            ('address_2', orm['core.foreignparticipatingcenter:address_2']),
            ('country', orm['core.foreignparticipatingcenter:country']),
            ('zip_code', orm['core.foreignparticipatingcenter:zip_code']),
