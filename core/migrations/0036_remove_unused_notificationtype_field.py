...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_notificationtype', 'model', self.gf('django.db.models.fields.CharField')(default='ecs.core.models.Notification', max_length=80), keep_default=False)
