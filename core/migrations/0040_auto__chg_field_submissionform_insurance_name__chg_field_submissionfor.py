...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_submissionform', 'insurance_name', self.gf('django.db.models.fields.CharField')(max_length=125, null=True, blank=True))

        # Changing field 'SubmissionForm.subject_duration'
        db.alter_column('core_submissionform', 'subject_duration', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'SubmissionForm.subject_planned_total_duration'
        db.alter_column('core_submissionform', 'subject_planned_total_duration', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'SubmissionForm.substance_p_c_t_application_type'
        db.alter_column('core_submissionform', 'substance_p_c_t_application_type', self.gf('django.db.models.fields.CharField')(max_length=145, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.insurance_name'
        db.alter_column('core_submissionform', 'insurance_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True))
