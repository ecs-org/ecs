...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.study_plan_biometric_planning'
        db.alter_column('core_submissionform', 'study_plan_biometric_planning', self.gf('django.db.models.fields.CharField')(max_length=260))

        # Changing field 'SubmissionForm.study_plan_statistics_implementation'
        db.alter_column('core_submissionform', 'study_plan_statistics_implementation', self.gf('django.db.models.fields.CharField')(max_length=270))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.study_plan_biometric_planning'
        db.alter_column('core_submissionform', 'study_plan_biometric_planning', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'SubmissionForm.study_plan_statistics_implementation'
        db.alter_column('core_submissionform', 'study_plan_statistics_implementation', self.gf('django.db.models.fields.CharField')(max_length=120))
