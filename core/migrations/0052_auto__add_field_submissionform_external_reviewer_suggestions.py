...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.external_reviewer_suggestions'
        db.add_column('core_submissionform', 'external_reviewer_suggestions', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.external_reviewer_suggestions'
        db.delete_column('core_submissionform', 'external_reviewer_suggestions')
