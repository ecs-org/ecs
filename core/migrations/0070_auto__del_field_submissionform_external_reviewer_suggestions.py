...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('core_submissionform', 'external_reviewer_suggestions', self.gf('django.db.models.fields.TextField')(default='nicht zutreffend'), keep_default=False)
    ...
    models = {
        ...
        'core.temporaryauthorization': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 12, 18, 25, 34, 852543)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
