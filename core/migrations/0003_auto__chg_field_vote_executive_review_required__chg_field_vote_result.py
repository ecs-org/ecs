...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.result'
        db.alter_column('core_vote', 'result', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vote.result'
        db.alter_column('core_vote', 'result', self.gf('django.db.models.fields.CharField')(max_length=2))
