...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_nontesteduseddrug', (
            ('id', orm['core.nontesteduseddrug:id']),
            ('submission_form', orm['core.nontesteduseddrug:submission_form']),
            ('generic_name', orm['core.nontesteduseddrug:generic_name']),
            ('preparation_form', orm['core.nontesteduseddrug:preparation_form']),
            ('dosage', orm['core.nontesteduseddrug:dosage']),
        ))
    ...
    def backwards(self, orm):
        ...
        db.create_table('core_nontesteduseddrugs', (
            ('preparation_form', orm['core.nontesteduseddrug:preparation_form']),
            ('submission', orm['core.nontesteduseddrug:submission']),
            ('generic_name', orm['core.nontesteduseddrug:generic_name']),
            ('id', orm['core.nontesteduseddrug:id']),
            ('dosage', orm['core.nontesteduseddrug:dosage']),
        ))
