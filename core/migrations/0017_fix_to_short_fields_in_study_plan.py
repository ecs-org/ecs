...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.study_plan_dataprotection_anonalgoritm'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'study_plan_dataprotection_anonalgoritm', orm['core.submissionform:study_plan_dataprotection_anonalgoritm'])
