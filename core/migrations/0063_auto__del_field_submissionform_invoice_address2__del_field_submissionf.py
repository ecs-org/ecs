...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_submissionform', 'invoice_address2')
        db.delete_column('core_submissionform', 'sponsor_address2')

        db.rename_column('core_submissionform', 'insurance_address_1', 'insurance_address')
        db.rename_column('core_submissionform', 'sponsor_address1', 'sponsor_address')
        db.rename_column('core_submissionform', 'invoice_address1', 'invoice_address')


    def backwards(self, orm):
        
        db.add_column('core_submissionform', 'invoice_address2', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True), keep_default=False)
        db.add_column('core_submissionform', 'sponsor_address2', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True), keep_default=False)

        db.rename_column('core_submissionform', 'insurance_address', 'insurance_address_1')
        db.rename_column('core_submissionform', 'sponsor_address', 'sponsor_address1')
        db.rename_column('core_submissionform', 'invoice_address', 'invoice_address1')
