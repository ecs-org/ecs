...
class Migration:
    ...
    def forwards(self, orm):
        orm.NotificationType.objects.filter(name__in=('Jahresbericht', 'Abschlussbericht')).update(form='ecs.core.forms.ExtendedNotificationForm')
    
    def backwards(self, orm):
        orm.NotificationType.objects.update(form='')
