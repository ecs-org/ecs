...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.ec_number'
        db.add_column('core_submission', 'ec_number', orm['core.submission:ec_number'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Submission.ec_number'
        db.delete_column('core_submission', 'ec_number')
