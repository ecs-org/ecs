...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field befangene on 'SubmissionForm'
        db.delete_table('core_submissionform_befangene')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field befangene on 'SubmissionForm'
        db.create_table('core_submissionform_befangene', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('submissionform', models.ForeignKey(orm['core.submissionform'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_submissionform_befangene', ['submissionform_id', 'user_id'])
    ...
    models = {
        ...
        'core.submission': {
            ...
            'befangene': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'befangen_for_submission'", 'null': 'True', 'to': "orm['auth.User']"}),
