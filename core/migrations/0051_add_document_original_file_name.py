...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.original_file_name'
        db.add_column('core_document', 'original_file_name', orm['core.document:original_file_name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Document.original_file_name'
        db.delete_column('core_document', 'original_file_name')
