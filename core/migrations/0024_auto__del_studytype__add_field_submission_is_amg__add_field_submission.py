...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('core_studytype')
        ...
        # Removing M2M table for field study_types on 'Submission'
        db.delete_table('core_submission_study_types')


    def backwards(self, orm):
        
        # Adding model 'StudyType'
        db.create_table('core_studytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10, unique=True, db_index=True)),
        ))
        db.send_create_signal('core', ['StudyType'])
        ...
        # Adding M2M table for field study_types on 'Submission'
        db.create_table('core_submission_study_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('submission', models.ForeignKey(orm['core.submission'], null=False)),
            ('studytype', models.ForeignKey(orm['core.studytype'], null=False))
        ))
        db.create_unique('core_submission_study_types', ['submission_id', 'studytype_id'])
    ...
    models = {
        ...
        'core.assignedmedicalcategory': {
            'Meta': {'unique_together': "(('category', 'meeting'),)", 'object_name': 'AssignedMedicalCategory'},
            'board_members': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'null': 'True', 'symmetrical': 'False'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.MedicalCategory']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'medical_categories'", 'to': "orm['core.Meeting']"})
        },
        'core.checklist': {
        ...
        'core.page': {
            ...
            'doc': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Document']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.submissionform': {
            ...
            'pdf_document': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submission_forms'", 'null': 'True', 'to': "orm['core.Document']"}),
