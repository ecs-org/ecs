...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_documenttype', (
            ('id', orm['core.documenttype:id']),
            ('name', orm['core.documenttype:name']),
        ))
        db.send_create_signal('core', ['DocumentType'])
        
        # Adding field 'Document.file'
        db.add_column('core_document', 'file', orm['core.document:file'])
        
        # Adding field 'Document.doctype'
        db.add_column('core_document', 'doctype', orm['core.document:doctype'])
        
        # Adding field 'Document.mimetype'
        db.add_column('core_document', 'mimetype', orm['core.document:mimetype'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_document', 'file')
        
        # Deleting field 'Document.doctype'
        db.delete_column('core_document', 'doctype_id')
        
        # Deleting field 'Document.mimetype'
        db.delete_column('core_document', 'mimetype')
