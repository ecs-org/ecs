...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission.billed_at'
        db.add_column('core_submission', 'billed_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission.billed_at'
        db.delete_column('core_submission', 'billed_at')
