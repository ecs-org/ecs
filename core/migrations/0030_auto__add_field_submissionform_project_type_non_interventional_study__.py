...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.project_type_non_interventional_study'
        db.add_column('core_submissionform', 'project_type_non_interventional_study', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SubmissionForm.project_type_gender_medicine'
        db.add_column('core_submissionform', 'project_type_gender_medicine', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.project_type_non_interventional_study'
        db.delete_column('core_submissionform', 'project_type_non_interventional_study')

        # Deleting field 'SubmissionForm.project_type_gender_medicine'
        db.delete_column('core_submissionform', 'project_type_gender_medicine')
