...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.is_notification_update'
        db.add_column('core_submissionform', 'is_notification_update', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.is_notification_update'
        db.delete_column('core_submissionform', 'is_notification_update')
