...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'BaseNotificationForm.submission_forms'
        db.create_table('core_basenotificationform_submission_forms', (
        ...
        # Deleting field 'BaseNotificationForm.submission_form'
        db.delete_column('core_basenotificationform', 'submission_form_id')
        
    
    def backwards(self, orm):
        
        # Dropping ManyToManyField 'BaseNotificationForm.submission_forms'
        db.delete_table('core_basenotificationform_submission_forms')
        
        # Adding field 'BaseNotificationForm.submission_form'
        db.add_column('core_basenotificationform', 'submission_form', orm['core.basenotificationform:submission_form'])
