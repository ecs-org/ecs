...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding ManyToManyField 'BaseNotificationForm.investigators'
        db.create_table('core_basenotificationform_investigators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('basenotificationform', models.ForeignKey(orm.BaseNotificationForm, null=False)),
            ('investigator', models.ForeignKey(orm.Investigator, null=False))
        ))
        
        # Adding ManyToManyField 'BaseNotificationForm.documents'
        db.create_table('core_basenotificationform_documents', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('basenotificationform', models.ForeignKey(orm.BaseNotificationForm, null=False)),
            ('document', models.ForeignKey(orm.Document, null=False))
        ))
        
        # Deleting field 'BaseNotificationForm.ek_number'
        db.delete_column('core_basenotificationform', 'ek_number')
        
        # Deleting field 'BaseNotificationForm.date_of_vote'
        db.delete_column('core_basenotificationform', 'date_of_vote')
        
        # Deleting field 'BaseNotificationForm.notification'
        db.delete_column('core_basenotificationform', 'notification_id')
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'BaseNotificationForm.investigators'
        db.delete_table('core_basenotificationform_investigators')
        
        # Dropping ManyToManyField 'BaseNotificationForm.documents'
        db.delete_table('core_basenotificationform_documents')
        
        # Adding field 'BaseNotificationForm.ek_number'
        db.add_column('core_basenotificationform', 'ek_number', orm['core.basenotificationform:ek_number'])
        
        # Adding field 'BaseNotificationForm.date_of_vote'
        db.add_column('core_basenotificationform', 'date_of_vote', orm['core.basenotificationform:date_of_vote'])
        
        # Adding field 'BaseNotificationForm.notification'
        db.add_column('core_basenotificationform', 'notification', orm['core.basenotificationform:notification'])
        
        # Adding model 'involvedcommissionsfornotification'
        db.create_table('core_involvedcommissionsfornotification', (
            ('submission', orm['core.basenotificationform:submission']),
            ('commission', orm['core.basenotificationform:commission']),
            ('examiner_name', orm['core.basenotificationform:examiner_name']),
            ('main', orm['core.basenotificationform:main']),
            ('id', orm['core.basenotificationform:id']),
        ))
        db.send_create_signal('core', ['involvedcommissionsfornotification'])
        
        # Adding model 'notification'
        db.create_table('core_notification', (
            ('documents', orm['core.basenotificationform:documents']),
            ('submission', orm['core.basenotificationform:submission']),
            ('workflow', orm['core.basenotificationform:workflow']),
            ('answer', orm['core.basenotificationform:answer']),
            ('id', orm['core.basenotificationform:id']),
        ))
