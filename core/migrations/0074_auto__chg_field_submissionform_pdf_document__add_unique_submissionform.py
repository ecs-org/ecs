...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.pdf_document'
        db.alter_column('core_submissionform', 'pdf_document_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['documents.Document']))

        # Adding unique constraint on 'SubmissionForm', fields ['pdf_document']
        db.create_unique('core_submissionform', ['pdf_document_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SubmissionForm', fields ['pdf_document']
        db.delete_unique('core_submissionform', ['pdf_document_id'])

        # Changing field 'SubmissionForm.pdf_document'
        db.alter_column('core_submissionform', 'pdf_document_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['documents.Document']))
