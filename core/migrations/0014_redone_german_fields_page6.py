...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.german_protected_subjects_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_protected_subjects_info', orm['core.submissionform:german_protected_subjects_info'])
        
        # Changing field 'SubmissionForm.german_preclinical_results'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_preclinical_results', orm['core.submissionform:german_preclinical_results'])
        
        # Changing field 'SubmissionForm.german_recruitment_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_recruitment_info', orm['core.submissionform:german_recruitment_info'])
        
        # Changing field 'SubmissionForm.german_concurrent_study_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_concurrent_study_info', orm['core.submissionform:german_concurrent_study_info'])
        
        # Changing field 'SubmissionForm.german_summary'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_summary', orm['core.submissionform:german_summary'])
        
        # Changing field 'SubmissionForm.german_ethical_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_ethical_info', orm['core.submissionform:german_ethical_info'])
        
        # Changing field 'SubmissionForm.german_risks_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_risks_info', orm['core.submissionform:german_risks_info'])
        
        # Changing field 'SubmissionForm.german_inclusion_exclusion_crit'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_inclusion_exclusion_crit', orm['core.submissionform:german_inclusion_exclusion_crit'])
        
        # Changing field 'SubmissionForm.german_benefits_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_benefits_info', orm['core.submissionform:german_benefits_info'])
        
        # Changing field 'SubmissionForm.german_relationship_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_relationship_info', orm['core.submissionform:german_relationship_info'])
        
        # Changing field 'SubmissionForm.german_sideeffects_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_sideeffects_info', orm['core.submissionform:german_sideeffects_info'])
        
        # Changing field 'SubmissionForm.german_primary_hypothesis'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_primary_hypothesis', orm['core.submissionform:german_primary_hypothesis'])
        
        # Changing field 'SubmissionForm.german_consent_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_consent_info', orm['core.submissionform:german_consent_info'])
        
        # Changing field 'SubmissionForm.german_project_title'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_project_title', orm['core.submissionform:german_project_title'])
