...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ForeignParticipatingCenter.city'
        db.delete_column('core_foreignparticipatingcenter', 'city')

        # Deleting field 'ForeignParticipatingCenter.country'
        db.delete_column('core_foreignparticipatingcenter', 'country')

        # Deleting field 'ForeignParticipatingCenter.address_1'
        db.delete_column('core_foreignparticipatingcenter', 'address_1')

        # Deleting field 'ForeignParticipatingCenter.address_2'
        db.delete_column('core_foreignparticipatingcenter', 'address_2')

        # Deleting field 'ForeignParticipatingCenter.zip_code'
        db.delete_column('core_foreignparticipatingcenter', 'zip_code')

        # Adding field 'ForeignParticipatingCenter.investigator_name'
        db.add_column('core_foreignparticipatingcenter', 'investigator_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Adding field 'ForeignParticipatingCenter.city'
        db.add_column('core_foreignparticipatingcenter', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'ForeignParticipatingCenter.country'
        db.add_column('core_foreignparticipatingcenter', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=4), keep_default=False)

        # Adding field 'ForeignParticipatingCenter.address_1'
        db.add_column('core_foreignparticipatingcenter', 'address_1', self.gf('django.db.models.fields.CharField')(default='', max_length=60), keep_default=False)

        # Adding field 'ForeignParticipatingCenter.address_2'
        db.add_column('core_foreignparticipatingcenter', 'address_2', self.gf('django.db.models.fields.CharField')(default='', max_length=60), keep_default=False)

        # Adding field 'ForeignParticipatingCenter.zip_code'
        db.add_column('core_foreignparticipatingcenter', 'zip_code', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Deleting field 'ForeignParticipatingCenter.investigator_name'
        db.delete_column('core_foreignparticipatingcenter', 'investigator_name')
    ...
    models = {
        ...
        'core.submissionform': {
            ...
            'expedited': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'external_reviewer': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'retrospective': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'thesis': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
