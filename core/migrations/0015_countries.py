...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubmissionForm.substance_registered_in_countries'
        db.delete_column('core_submissionform', 'substance_registered_in_countries')

        # Deleting field 'SubmissionForm.substance_p_c_t_countries'
        db.delete_column('core_submissionform', 'substance_p_c_t_countries')
        ...
        db.create_table('core_submissionform_substance_registered_in_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('submissionform', models.ForeignKey(orm['core.submissionform'], null=False)),
            ('country', models.ForeignKey(orm['countries.country'], null=False))
        ))
        db.create_unique('core_submissionform_substance_registered_in_countries', ['submissionform_id', 'country_id'])
    
    
    def backwards(self, orm):
        
        # Adding field 'SubmissionForm.substance_registered_in_countries'
        db.add_column('core_submissionform', 'substance_registered_in_countries', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)

        # Adding field 'SubmissionForm.substance_p_c_t_countries'
        db.add_column('core_submissionform', 'substance_p_c_t_countries', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)
        ...
        db.delete_table('core_submissionform_substance_registered_in_countries')
