...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field medical_categories on 'SubmissionForm'
        db.create_table('core_submissionform_medical_categories', (
        ...
        db.create_unique('core_submissionform_medical_categories', ['submissionform_id', 'medicalcategory_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field medical_categories on 'SubmissionForm'
        db.delete_table('core_submissionform_medical_categories')
