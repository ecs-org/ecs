...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.german_aftercare_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_aftercare_info', orm['core.submissionform:german_aftercare_info'])
        
        # Changing field 'SubmissionForm.german_dataprotection_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_dataprotection_info', orm['core.submissionform:german_dataprotection_info'])
        
        # Changing field 'SubmissionForm.german_abort_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_abort_info', orm['core.submissionform:german_abort_info'])
        
        # Changing field 'SubmissionForm.german_additional_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_additional_info', orm['core.submissionform:german_additional_info'])
        
        # Changing field 'SubmissionForm.german_payment_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_payment_info', orm['core.submissionform:german_payment_info'])
        
        # Changing field 'SubmissionForm.german_financing_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_financing_info', orm['core.submissionform:german_financing_info'])
        
        # Changing field 'SubmissionForm.german_dataaccess_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_dataaccess_info', orm['core.submissionform:german_dataaccess_info'])
        
        # Changing field 'SubmissionForm.german_statistical_info'
        # (to signature: django.db.models.fields.TextField(null=True))
        db.alter_column('core_submissionform', 'german_statistical_info', orm['core.submissionform:german_statistical_info'])
