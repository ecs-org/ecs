...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.additional_therapy_info'
        db.alter_column('core_submissionform', 'additional_therapy_info', self.gf('django.db.models.fields.TextField')(blank=True))

        # Changing field 'SubmissionForm.german_financing_info'
        db.alter_column('core_submissionform', 'german_financing_info', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

        # Changing field 'SubmissionForm.german_dataaccess_info'
        db.alter_column('core_submissionform', 'german_dataaccess_info', self.gf('django.db.models.fields.TextField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.additional_therapy_info'
        db.alter_column('core_submissionform', 'additional_therapy_info', self.gf('django.db.models.fields.TextField')())

        # Changing field 'SubmissionForm.german_financing_info'
        db.alter_column('core_submissionform', 'german_financing_info', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'SubmissionForm.german_dataaccess_info'
        db.alter_column('core_submissionform', 'german_dataaccess_info', self.gf('django.db.models.fields.TextField')(null=True))
