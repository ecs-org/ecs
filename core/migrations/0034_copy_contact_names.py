...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.SubmissionForm.objects.update(
            sponsor_contact_last_name=models.F('sponsor_contactname'),
            invoice_contact_last_name=models.F('invoice_contactname'),
            submitter_contact_last_name=models.F('submitter_name'),
        )
        orm.Investigator.objects.update(
            contact_last_name=models.F('name'),
        )
