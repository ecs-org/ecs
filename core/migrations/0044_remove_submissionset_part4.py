...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubmissionForm.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['core.Submission']))
        db.alter_column('core_submissionform', 'submission_id', orm['core.submissionform:submission'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubmissionForm.submission'
        # (to signature: django.db.models.fields.related.ForeignKey(null=True, to=orm['core.Submission']))
        db.alter_column('core_submissionform', 'submission_id', orm['core.submissionform:submission'])
