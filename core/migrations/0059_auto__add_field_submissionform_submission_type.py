...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.submission_type'
        db.add_column('core_submissionform', 'submission_type', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.submission_type'
        db.delete_column('core_submissionform', 'submission_type')
