...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ExpeditedReviewCategory', fields ['abbrev']
        db.create_unique('core_expeditedreviewcategory', ['abbrev'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ExpeditedReviewCategory', fields ['abbrev']
        db.delete_unique('core_expeditedreviewcategory', ['abbrev'])
    ...
    models = {
        ...
        'core.checklistquestion': {
            'Meta': {'ordering': "('blueprint', 'index')", 'unique_together': "(('blueprint', 'number'), ('blueprint', 'index'))", 'object_name': 'ChecklistQuestion'},
