...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubmissionForm.study_plan_population_intention_to_treat'
        db.add_column('core_submissionform', 'study_plan_population_intention_to_treat', orm['core.submissionform:study_plan_population_intention_to_treat'])
        
        # Adding field 'SubmissionForm.study_plan_population_per_protocol'
        db.add_column('core_submissionform', 'study_plan_population_per_protocol', orm['core.submissionform:study_plan_population_per_protocol'])
        
        # Deleting field 'SubmissionForm.study_plan_8_3_2'
        db.delete_column('core_submissionform', 'study_plan_8_3_2')
        
        # Deleting field 'SubmissionForm.study_plan_8_3_1'
        db.delete_column('core_submissionform', 'study_plan_8_3_1')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubmissionForm.study_plan_population_intention_to_treat'
        db.delete_column('core_submissionform', 'study_plan_population_intention_to_treat')
        
        # Deleting field 'SubmissionForm.study_plan_population_per_protocol'
        db.delete_column('core_submissionform', 'study_plan_population_per_protocol')
        
        # Adding field 'SubmissionForm.study_plan_8_3_2'
        db.add_column('core_submissionform', 'study_plan_8_3_2', orm['core.submissionform:study_plan_8_3_2'])
        
        # Adding field 'SubmissionForm.study_plan_8_3_1'
        db.add_column('core_submissionform', 'study_plan_8_3_1', orm['core.submissionform:study_plan_8_3_1'])
