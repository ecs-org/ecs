...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_submissionform', 'substance_p_c_t_phase', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubmissionForm.substance_p_c_t_phase'
        db.alter_column('core_submissionform', 'substance_p_c_t_phase', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True))
