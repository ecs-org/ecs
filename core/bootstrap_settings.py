...
checklist_questions = {
    ...
    u'statistic_review': [
        ...
        ('2', u'Ist das Design der Studie geeignet, das Studienziel zu erreichen?',u''),
        ('3', u'Ist die Studienpopulation ausreichend definiert?',u''),
        ('4', u'Sind die Zielvariablen geeignet definiert?',u''),
        ('5', u'Ist die statistische Analyse beschrieben, und ist sie adäquat?',u''),
        ('6', u'Ist die Größe der Stichprobe ausreichend begründet?',u''),
    ],
    u'legal_review': [
        ( '1', u"Anrede: entspricht?",u''),
        ( '2', u"Hinweis auf Freiwilligkeit: entspricht?",u''),
        ( '3', u"Hinweis auf jederzeitigen Abbruch: entspricht?",u''),
        ( '4', u"Schwangerschaftspassus: entspricht?",u''),
        ( '5', u"Versicherungspassus: entspricht?",u''),
        ( '6', u"Name und Erreichbarkeit des Prüfarztes: entspricht?",u''),
        ( '7', u"Hinweis auf Patientenanwaltschaft: entspricht?",u''),
        ( '8', u"Vermeidung von Fremdwörtern: entspricht?",u''),
        ( '9', u"Rechtschreibung und Grammatik: entspricht?",u''),
        ('10', u"Die Patienteninformation entspricht in allen anderen Punkten den Anforderungen?",u''),
    ],
    u'insurance_review': [
        ('1', u"Sind die Angaben zu Versicherung vollständig und adäquat?",u''),
    ],
    u'external_review': [
        ...
        ('2',  u'Ist die Fragestellung des Projektes relevant/wenig relevant/bereits bearbeitet/irrelevant?',u''),
        ...
        ('5a', u'Werden dem Patienten/Probanden durch die für die Studie notwendigen Untersuchungen besondere Belastungen bzw. Risken zugemutet?',u''),
    ...
    u'gcp_review': [
        ...
        ( '3', u'Ist das Studienziel und der Studienzweck detailliert beschrieben?',u''),
        ( '4', u'Ist das Studiendesign ausreichend dargelegt? (Endpunkte, Studienphase, Bias-Vermeidung, Prüfpräparat, Labelling, Dauer, Beendigung, Accountability, Randomisierung, Source Daten)',u''),
        ( '5', u'Sind Patientenauswahl und Austritts- bzw. Abbruchkriterien ausreichend definiert? (Ein-/Ausschluss, Abbruch, Datenerhebung, follow up, Ersatz)',u''),
        ( '6', u'Ist die Behandlung der Studienteilnehmer, samt erlaubter/nicht erlaubter Medikation und Überprüfungsverfahren ausreichend definiert?',u''),
        ( '7', u'Sind die Efficacy Parameter sowie Methoden, zeitliche Planung und Erfassung & Analyse d. Efficacy Parameter ausreichend definiert?',u''),
        ( '8', u'Ist Safety und Safety Reporting Parameter ausreichend definiert, und adäquat?',u''),
        ( '9', u'Sind die Angaben zur statistischen Datenerhebung, -Auswertung, -Methoden ausreichend und adäquat?',u''),
        ('10', u'Ist die Qualitätskontrolle und Qualitätssicherung ausreichend beschrieben und sind diese Angaben adäquat?',u''),
        ('11', u'Sind Angaben zu ethischen Aspekten vorhanden?',u''),
        ('12', u'Sind Angaben zu Datenerhebung, Dokumentation und Verarbeitung ausreichend definiert und sind diese adäquat?',u''),
        ('13', u'Sind Angaben zu Finanzierung und Versicherung ausreichend definiert und sind diese adäquat?',u''),
        ('14', u'Sind Angaben zur Regelung bzgl Publikation ausreichend definiert?',u''),
        ('15', u'Anhang, wenn zutreffend?',u''),
    ],
