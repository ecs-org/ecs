...
VALID_SUBMISSION_FORM_DATA = {
    ...
    u'study_plan_statistics_implementation': [u'Mag. rer.soc.oec. Jane Doe / Statistikerin'], u'investigator-1-contact_last_name': [u''], 
    u'sponsor_fax': [u'+430987654345678'], u'substance_p_c_t_final_report': [u'2'], u'substance_registered_in_countries': [u'AT,FR'], 
    ...
    u'investigator-1-contact_gender': [u''], u'nontesteduseddrug-MAX_NUM_FORMS': [u''], u'investigatoremployee-INITIAL_FORMS': [u'0'], u'insurance_phone': [u'1234567'], 
    ...
    u'investigator-0-contact_first_name': [u''], u'nontesteduseddrug-0-dosage': [u''], u'insurance_contract_number': [u'2323'], u'study_plan_power': [u'0.80'], 
    ...
    u'study_plan_dataquality_checking': [u'National coordinators'], 
    ...
    u'investigator-0-contact_last_name': [u'Univ. Doz. Dr. Jane Doe'], u'medtech_departure_from_regulations': [u''], 
