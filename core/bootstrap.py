...
def checklist_questions():
    questions = {
        ...
        u'legal_review': [
                          (u"Anrede: entspricht?",u''),
                          (u"Hinweis auf Freiwilligkeit: entspricht?",u''),
                          (u"Hinweis auf jederzeitigen Abbruch: entspricht?",u''),
                          (u"Schwangerschaftspassus: entspricht?",u''),
                          (u"Versicherungspassus: entspricht?",u''),
                          (u"Name und Erreichbarkeit des Prüfarztes: entspricht?",u''),
                          (u"Hinweis auf Patientenanwaltschaft: entspricht?",u''),
                          (u"Vermeidung von Fremdwörtern: entspricht?",u''),
                          (u"Rechtschreibung und Grammatik: entspricht?",u''),
                          (u"Die Patienteninformation entspricht in allen anderen Punkten den Anforderungen?",u''),
                          ],
