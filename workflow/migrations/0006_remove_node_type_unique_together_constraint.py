...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'NodeType', fields ['implementation', 'content_type']
        db.delete_unique('workflow_nodetype', ['implementation', 'content_type_id'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'NodeType', fields ['implementation', 'content_type']
        db.create_unique('workflow_nodetype', ['implementation', 'content_type_id'])
