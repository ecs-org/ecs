...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NodeType.data_type'
        db.add_column('workflow_nodetype', 'data_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Node.data_ct'
        db.add_column('workflow_node', 'data_ct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Node.data_id'
        db.add_column('workflow_node', 'data_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'NodeType.data_type'
        db.delete_column('workflow_nodetype', 'data_type_id')

        # Deleting field 'Node.data_ct'
        db.delete_column('workflow_node', 'data_ct_id')

        # Deleting field 'Node.data_id'
        db.delete_column('workflow_node', 'data_id')
