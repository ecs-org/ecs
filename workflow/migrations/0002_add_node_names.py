...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('workflow_node', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Node.name'
        db.delete_column('workflow_node', 'name')
